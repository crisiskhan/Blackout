...
reserves (a named nature reserve, a mountain ACEC, a prairie preserve, Hueco Tanks, named open-space cover, a scenic easement, or La Tierra Trails), not picnic woodland.
...
this is range, not a pin. Godzilla Preserve and Open Space Visitor Center stay parks. Holding an open reserve — a named nature reserve, a mountain ACEC, a prairie preserve, Hueco Tanks, named open-space cover, a scenic easement, or La Tierra Trails — opens that pack's bite and cactus cards, not picnic tree-use. Open Space Visitor Center, a farm open space, and bosque along the Rio Grande stay parks. A riverside hike-and-bike easement stays a park. Tierra Blanca and a trails neighborhood park stay parks. Holding scrub opens that pack's bite and mammal cards;
holding a hole
