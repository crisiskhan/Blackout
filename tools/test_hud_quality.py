...
class WholeWordHUDTests(unittest.TestCase):
    def test_overlay_chips_are_the_whole_words(self):
        ...
        self.assertIn('godsEyeTitle = "EYE"', tokens)
...
class MapCanvasHonestyTests(unittest.TestCase):
    ...
    def test_gods_eye_fits_the_pack_and_drops_lock_on(self):
        ...
        rail = tab.split("private var overlayRail")[1].split("private var eyeDeskRail")[0]
        ...
        self.assertIn("static let godsEyePitch: Double = 50", cam)
        self.assertIn("static let godsEyeRangeFactor", cam)
        ...
        self.assertIn("view.fly(", fit)
        self.assertIn("to: camera", fit)
        self.assertNotIn("flyToCamera", fit)
        self.assertIn("fitting:", fit)
        ...
        self.assertIn("PackCamera.godsEyeCameraDistance", fit)
        self.assertIn("viewingDistance", fit)
        self.assertIn("PackCamera.packCenter", fit)
        self.assertIn("PackCamera.godsEyeFlySeconds", fit)
        self.assertIn("peakAltitude", fit)
        self.assertIn("PackCamera.godsEyeFlyPeakAltitude", fit)
        self.assertIn("EyeDesk.framePoints", fit)
        self.assertIn("EyeDesk.clampToPack", fit)
        ...
        self.assertIn("satelliteShadeOpacity", desk)
        self.assertIn("satelliteShadeOpacity", offline)
        self.assertIn("satelliteRoadOpacity", offline)
        ...
        self.assertIn("EyeDesk.satelliteRoadOpacity", eye_layers)
        self.assertNotIn("satelliteRoadOpacity : 1", eye_layers)
        ...
        self.assertIn("`EYE`", qa)
        self.assertIn("frames the party", qa)
