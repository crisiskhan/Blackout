...
class ExpeditionNamedTimerTests(unittest.TestCase):
    def test_named_group_timers_show_progress_on_profile(self):
        ...
        self.assertIn('Button("2H")', exped)
        self.assertIn("timerSeconds", exped)
        self.assertIn("timerSeq", exped)
        self.assertIn("duration: timerSeconds", exped)
        ...
        self.assertIn("NAME + 1 MIN / 5 MIN / 2H + SET", qa)
        self.assertIn("remaining bar", qa)
        self.assertIn("1 MIN / 5 MIN / 2H", qa)
