...
class MapCanvasHonestyTests(unittest.TestCase):
    ...
    def test_walking_desk_keeps_the_photo_and_drops_eye_mode(self):
        ...
        self.assertIn('key == "mark water"', parse)
        ...
        self.assertIn('sectionLabel("MARK")', inst)
        self.assertIn("EyeDesk.MarkKind.allCases", inst)
        ...
        self.assertIn("MARK kinds live on the MAP plate", qa)
        ...
        self.assertIn("MARK kinds live on the MAP plate", device)
...
class MapHoldScrollAndPlateRailTests(unittest.TestCase):
    ...
    def test_instruments_is_a_plate_rail_not_one_long_dump(self):
        ...
        self.assertIn("fieldYou == nil", mapping)
        self.assertIn('sectionLabel("MARK")', mapping)
        self.assertIn("EyeDesk.MarkKind.allCases", mapping)
        self.assertIn("plantEyeMark", mapping)
        root = read("Blackout", "RootChrome.swift")
