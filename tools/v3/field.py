...
def thickness_state() -> list[dict]:
    ...
    trees = [
        ...
        (
            ...
            "You are in New Mexico woodland, park, or bosque. Rio Grande cottonwood, juniper, piñon, or aspen. Shade and wind. Piñon is not a Field meal ticket.",
            "Estás en arbolado, parque o bosque de Nuevo México. Álamo del Río Grande, enebro, piñón o álamo temblón. Sombra y viento. El piñón no es un ticket de comida de Field.",
