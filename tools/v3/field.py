...
def core_cards() -> list[dict]:
    ...
    cards.append(
        card(
            "med-airway",
            "medical",
            "Choke — cannot cough or speak",
            "Atragantamiento — no tose ni habla",
            "Food or an object is stuck. They cannot cough or say a word. Silent, grabbing the throat.",
            "Comida u objeto atorado. No pueden toser ni decir una palabra. Silencio, se agarran la garganta.",
            [
                ("They cough it out and can say a word.", "Tosen el bloqueo y pueden decir una palabra."),
                ("They go down or the chest stops — that is CPR. Look in the mouth each time the chest comes up.", "Se caen o el pecho para: eso es RCP. Mira la boca cada vez que el pecho sube."),
            ],
            ...
            [
                step(
                    "If they can cough or speak, let them cough. Stay next to them. Nothing in the mouth.",
                    "Air can still move if they cough. Fingers can push the block deeper.",
                    "Say: cough it out. I am right here. Hands off the mouth.",
                    "If they go silent and cannot breathe, go to back blows now.",
                    "airway.png",
                    "Si pueden toser o hablar, déjalos toser. Quédate. Nada en la boca.",
                    "El aire aún pasa si tosen. Los dedos pueden empujar el bloqueo.",
                    "Di: tóselo. Estoy aquí. Manos fuera de la boca.",
                    "Si se callan y no respiran, pasa a golpes en la espalda ya.",
                    tick_s=10,
                ),
                step(
                    "If they cannot cough, speak, or breathe: five hard back blows between the shoulders. Then look in the mouth. Only sweep what you can see.",
                    "A hard blow can move a block. Blind fingers lodge it.",
                    "Say: I am hitting your back. Lean forward. Stand to the side, not the neck.",
                    "Stop if they start coughing or breathing.",
                    "airway.png",
                    "Si no pueden toser, hablar ni respirar: cinco golpes fuertes entre los hombros. Luego mira la boca. Solo saca lo que ves.",
                    "Un golpe fuerte puede mover el bloqueo. Dedos a ciegas lo clavan.",
                    "Di: te pego en la espalda. Inclínate. A un lado, no en el cuello.",
                    "Para si empiezan a toser o respirar.",
                    tick_s=15,
                ),
                step(
                    "If the block stays: five inward-up thrusts above the navel. Baby: five chest thrusts, not the belly. Pregnant, or you cannot reach around: five chest thrusts.",
                    "The next move matches the body. A belly thrust on a baby or a pregnant belly is the wrong force.",
                    "Say the count out loud. Fist above the navel — or on the chest if that is the body.",
                    "If they go down, start CPR. Look in the mouth each time the chest comes up.",
                    "airway.png",
                    "Si el bloqueo sigue: cinco empujes adentro y arriba sobre el ombligo. Bebé: cinco en el pecho, no el vientre. Embarazo, o no alcanzas: cinco en el pecho.",
                    "El siguiente movimiento coincide con el cuerpo. El vientre de un bebé o un embarazo es la fuerza equivocada.",
                    "Di la cuenta. Puño sobre el ombligo — o en el pecho si ese es el cuerpo.",
                    "Si se caen, empieza RCP. Mira la boca cada vez que el pecho sube.",
                    tick_s=20,
                ),
            ],
        )
    ...
    return [
        ...
        card(
            ...
            [
                ...
                step(
                    "Hog-sized game cooks longer than deer-sized. No pink, no bloody juice. Coals or a pot. Juice runs clear. No raw liver. Keep raw off the ready pile. Wash hands and knives.",
                    ...
                    "Stop if grease fire starts — lid, not water.",
                    "food-boil.png",
                    "La caza grande se cocina más que la chica. Sin rosa, sin jugo de sangre. Brasas u olla. Jugo claro. Nada de hígado crudo. Separa crudo de listo. Lava manos y cuchillos.",
...
def manual_core() -> list[dict]:
    """Fieldcraft holes the bushcraft manuals spend chapters on. Original steps."""
    return [
        card(
            "camp-layers",
            "tactics",
            "Clothing is a system",
            "La ropa es un sistema",
            "The shirt is wet or the sun is on the head. What is next to skin is the engine.",
            "La camisa está mojada o el sol está en la cabeza. Lo que va pegado a la piel es el motor.",
            [
                ("They are dry, covered, and talking sense.", "Están secos, cubiertos y hablan con sentido."),
                ("Shivering stopped in the cold, or sweat stopped in the heat — those cards now.", "Dejó de temblar en el frío o de sudar en el calor: esas tarjetas ahora."),
            ],
            "Wet cotton next to skin is a dump. Get to care for confusion. The trunk card is treatment, this is the clothing.",
            "El algodón mojado pegado a la piel tira calor. Busca cuidado si hay confusión. La tarjeta del tronco es el tratamiento, esta es la ropa.",
            [
                step(
                    "Wet cotton next to skin comes off. Wool or a synthetic stays useful wet; cotton does not. Hat on in the sun, off only in a true lee. Next-to-skin dry, wind layer next, rain on the outside. Hands and head last to uncover. Dry the child first.",
                    "The engine is the middle. A wet t-shirt in wind is how a walk becomes the cold card.",
                    "Child gets the dry layer and the hat first. No toughness shirt.",
                    "Stop the 'it will dry on me' march. Change, then walk.",
                    "cold-rewarm.png",
                    "El algodón mojado pegado a la piel sale. La lana o un sintético siguen sirviendo mojados; el algodón no. Sombrero en el sol, fuera solo en un abrigo de verdad. Pegado a la piel seco, luego viento, la lluvia afuera. Manos y cabeza al último en descubrirse. Seca al niño primero.",
                    "El motor es el medio. Una camiseta mojada al viento es cómo un caminar se vuelve la tarjeta de frío.",
                    "El niño recibe la capa seca y el sombrero primero. Sin camisa de aguante.",
                    "Para el 'se me seca encima'. Cambia, luego camina.",
                    party={"1": "Dry next-to-skin, hat in the sun.", "2": "One changes the cold person, one fetches dry.", "4": "Skin / wind / rain / kids first."},
                ),
            ],
        ),
        card(
            "camp-tape",
            "tactics",
            "Tape, bag, and a spare cloth",
            "Cinta, bolsa y un trapo de más",
            "You are missing a roof, a vessel, or a bandage and you still have contractor trash and tape.",
            "Te falta techo, recipiente o vendaje y aún tienes bolsa de obra y cinta.",
            [
                ("The five tools you can touch are already on you.", "Las cinco herramientas que puedes tocar ya van encima."),
                ("Blood is pulsing — pack-a-bleed, not a tape lecture.", "La sangre pulsa: taponar, no una lección de cinta."),
            ],
            "Tape is not a suture. A fuel bag is not a vessel. Care for a wound tape will not close.",
            "La cinta no es una sutura. Una bolsa de combustible no es recipiente. Cuidado si la herida no cierra con cinta.",
            [
                step(
                    "A clean bag is a vessel and a roof. Tape is a splint wrap, a tarp repair, and a blister pad. Spare cloth is a signal panel, a filter, and a bandage. Do not drink from a bag that held chemicals. Do not tape a wound shut that needs packing. Name it on the five-tools card, then use it.",
                    "The extras are still tools you can touch. Imaginary kit stays imaginary.",
                    "Child holds the clean cloth, not the tape on skin.",
                    "Stop if the bag smells like gas. That is not water and not a roof over a stove.",
                    "form-up.png",
                    "Una bolsa limpia es recipiente y techo. La cinta es férula, compostura de lona y almohadilla de ampolla. El trapo de más es panel, filtro y vendaje. No bebas de una bolsa que tuvo químicos. No cierres con cinta una herida que hay que taponar. Nómbralo en las cinco herramientas y úsalo.",
                    "Los extras siguen siendo herramientas que tocas. El kit imaginario se queda imaginario.",
                    "El niño sostiene el trapo limpio, no la cinta en la piel.",
                    "Para si la bolsa huele a gasolina. Eso no es agua ni un techo sobre una estufa.",
                    party={"1": "Bag, tape, cloth — name the hole they fill.", "2": "One roofs or wraps, one keeps the roll dry.", "4": "Roof / vessel / bandage / signal."},
                ),
            ],
        ),
        card(
            "shelter-knots",
            "shelter",
            "Taut line and a trucker's hitch",
            "Ballestrinque tenso y nudo de camionero",
            "The tarp is up and already flapping. The roof is only as good as the line.",
            "La lona está y ya aletea. El techo vale lo que vale la cuerda.",
            [
                ("The ridgeline is tight and the low wall is into the wind.", "La cumbrera está tensa y la pared baja va contra el viento."),
                ("Lightning is on you — drop the poles, this is not a kite.", "El rayo está encima: suelta los postes, esto no es un cometa."),
            ],
            "A flying tarp is a night without a roof. Hypothermia if the floor floods. Re-tie, then the insulation card.",
            "Una lona que vuela es una noche sin techo. Hipotermia si se inunda el piso. Reanuda, luego la tarjeta de aislamiento.",
            [
                step(
                    "Ridgeline first, taut line hitch so you can take slack without untying. Trucker's hitch on the corners you must crank. Low side into the wind. A knot you cannot undo in the dark with cold hands is a bad knot. Stake or deadman in sand. Then pile the floor.",
                    "A pretty lean-to that flaps dumps heat. Adjustable beats pretty.",
                    "Child stays off the ridgeline. They can hold the free end, not the pole in a storm.",
                    "Stop if the only tree is a widowmaker or the line is a live wire.",
                    "shelter-tarp.png",
                    "Cumbrera primero, ballestrinque tenso para poder recoger sin deshacer. Nudo de camionero en las esquinas que hay que tensar. Lado bajo contra el viento. Un nudo que no puedes deshacer a oscuras con manos frías es un mal nudo. Estaca o muerto en arena. Luego el piso.",
                    "Un refugio bonito que aletea tira el calor. Ajustable gana a bonito.",
                    "El niño fuera de la cumbrera. Puede sostener el cabo, no el poste en la tormenta.",
                    "Para si el único árbol es viudo o la línea es un cable vivo.",
                    party={"1": "Ridge, taut line, floor.", "2": "One ridges, one corners.", "4": "Ridge / corners / stakes / floor."},
                ),
            ],
        ),
        card(
            "nav-pace",
            "nav",
            "Pace count on a named line",
            "Cuenta de pasos en una línea con nombre",
            "The map pack is in the hand and the trail is a maybe. You need to know how far you actually walked.",
            "El pack del mapa está en la mano y el sendero es un quizás. Necesitas saber cuánto caminaste de verdad.",
            [
                ("You can see the named road, river, or ridge you aimed at.", "Ves el camino, río o filo con nombre al que apuntaste."),
                ("Two people have two counts — sit, this is the locate card.", "Dos personas tienen dos cuentas: siéntate, es la tarjeta de localizar."),
            ],
            "A count you did not write is a story. Care is the last known road, not a longer walk.",
            "Una cuenta que no escribiste es un cuento. El cuidado es el último camino conocido, no un caminar más largo.",
            [
                step(
                    "Pick a named line on this pack's map. Count a pair of steps — sixty pair is a starting guess toward 100 m for a tired adult, then calibrate on a known block. Write the count. Do not count while talking. Child can tally on a stick. If the count and the map disagree, STOP. The sun-and-drain card is the other handrail.",
                    "Distance is the thing people invent first. A stick tally does not invent.",
                    "Child tallies, does not lead.",
                    "Stop walking if the count says you should already see the road and you do not.",
                    "nav-stop.png",
                    "Elige una línea con nombre en el mapa de este pack. Cuenta pares de pasos: sesenta pares es un palpite hacia 100 m para un adulto cansado, luego calibra en una cuadra conocida. Escribe la cuenta. No cuentes hablando. El niño puede marcar en un palo. Si la cuenta y el mapa no coinciden, PARA. Sol y drenaje es la otra baranda.",
                    "La distancia es lo primero que se inventa. Una marca en un palo no inventa.",
                    "El niño marca, no lidera.",
                    "Para de caminar si la cuenta dice que ya deberías ver el camino y no lo ves.",
                    tick_s=120,
                    party={"1": "One line, one count, write it.", "2": "One walks, one tallies.", "4": "Line / count / child / no split."},
                ),
            ],
        ),
        card(
            "camp-pack",
            "tactics",
            "Carry the load so it does not carry you",
            "Carga el peso para que no te cargue",
            "The kit is on one person's back and the miles are not done. A wrecked hip is the night.",
            "El kit va en la espalda de uno y las millas no están hechas. Una cadera hecha polvo es la noche.",
            [
                ("The load is split and the straps are on the hips, not the neck.", "La carga está repartida y las correas van en las caderas, no en el cuello."),
                ("Someone cannot stand — that is a carry, not a packing lesson.", "Alguien no se para: es un acarreo, no una lección de empaque."),
            ],
            "A pack that wrecks the walker makes the trauma card. Split the weight. Care if they cannot stand.",
            "Una mochila que rompe al caminante hace la tarjeta de trauma. Reparte el peso. Cuidado si no se paran.",
            [
                step(
                    "Heavy close to the back, high enough that the hips take it, not the neck. Water and the blade where the hand is. Split the party weight — one person with everything is how a femur starts. Pad the straps. If it sways, it will dump you on scree. Tighten, then walk.",
                    "The pack is a tool. A pendulum is an injury.",
                    "Child carries water and a whistle, not the axe.",
                    "Stop if someone is leaning to one side and will not say it. Unpack, split, go.",
                    "form-up.png",
                    "Lo pesado pegado a la espalda, lo bastante alto para que las caderas lo tomen, no el cuello. Agua y filo donde está la mano. Reparte el peso del grupo: uno con todo es cómo empieza un fémur. Almohadilla las correas. Si se meces, te tira en el pedregal. Aprieta, luego camina.",
                    "La mochila es herramienta. Un péndulo es una lesión.",
                    "El niño lleva agua y silbato, no el hacha.",
                    "Para si alguien se inclina a un lado y no lo dice. Desarma, reparte, sigue.",
                    party={"1": "Hips, not neck.", "2": "Split the heavy.", "4": "Water / blade / shelter / no one hero-packs."},
                ),
            ],
        ),
        card(
            "env-sky",
            "environment",
            "Read the sky before the walk",
            "Lee el cielo antes de caminar",
            "Build-up, a wind shift, or a line of dark that was not there at breakfast. No live weather radio.",
            "Cumulonimbo, un cambio de viento o una línea oscura que no estaba al desayuno. Sin radio del clima en vivo.",
            [
                ("The sky is the same as an hour ago and you have a roof you can reach.", "El cielo es el de hace una hora y tienes un techo al que llegar."),
                ("You can already hear thunder on the ridge or a roar in the cut — those cards now.", "Ya oyes trueno en el filo o un rugido en la quebrada: esas tarjetas ahora."),
            ],
            "A guess at the sky is still a guess. Lightning, flood, and wind cards are the treatment. Care if you waited on a ridge.",
            "Una conjetura del cielo sigue siéndolo. Rayo, creciente y viento son el tratamiento. Cuidado si esperaste en un filo.",
            [
                step(
                    "Look. Tall towers with dark bases in this country mean lightning and a cutoff wash. A sudden cool gust the other way is a cell. Mare's tails can mean wind later, not now. If it is building, get off the high point and out of the cut before it arrives. Do not wait for the first drop on a ridge.",
                    "The sky is the only forecast this phone has. Pride on a summit is how the lightning card starts.",
                    "Child in the lee with the party, not 'watching the storm' on the crest.",
                    "Stop the walk the moment the towers go dark underneath. Roof, lee, high ground for flood — pick the one that matches.",
                    "heat-island.png",
                    "Mira. Torres altas con bases oscuras en este país son rayo y un arroyo que corta. Un golpe fresco de pronto al revés es una celda. Las colas de yegua pueden ser viento después, no ahora. Si está creciendo, baja del alto y sal de la quebrada antes de que llegue. No esperes la primera gota en un filo.",
                    "El cielo es el único pronóstico que tiene este teléfono. El orgullo en una cumbre es cómo empieza la tarjeta de rayo.",
                    "El niño al abrigo con el grupo, no 'viendo la tormenta' en la cresta.",
                    "Para la caminata cuando las torres se oscurecen abajo. Techo, abrigo, alto por creciente: elige el que corresponda.",
                    party={"1": "Look, then the matching weather card.", "2": "One watches sky, one starts the roof.", "4": "Sky / lee / cut / count."},
                ),
            ],
        ),
        card(
            "tact-breathe",
            "tactics",
            "Sit until the heart slows",
            "Siéntate hasta que baje el corazón",
            "Panic, a fight, or a bad pip. The next decision will be worse while the heart is a drum.",
            "Pánico, una pelea o un pip malo. La siguiente decisión será peor mientras el corazón sea un tambor.",
            [
                ("They are talking sense and the party is counted.", "Hablan con sentido y el grupo está contado."),
                ("Someone is bleeding, not breathing, or in a rising cut — those cards now, then sit.", "Alguien sangra, no respira o está en una quebrada que sube: esas tarjetas ahora, luego siéntate."),
            ],
            "Fear is not a plan. Care if confusion does not clear. Then the starting-from-nothing card is the order of work.",
            "El miedo no es un plan. Cuidado si la confusión no pasa. Luego la tarjeta de empezar desde nada es el orden.",
            [
                step(
                    "STOP. Sit. Count the party out loud. Three slow breaths you can hear. Water if they can swallow sitting. Then name the actual problem — bleed, water, roof, lost — and open that card. Do not run. Do not split. Slow the heart first or the next mile is a circle.",
                    "A fast heart makes a fast bad map. Sitting is a skill.",
                    "Give the child a count job. They are not the audience for the panic.",
                    "Stop shouting names into the dark. Sit, count, then the form-up card if someone is missing.",
                    "form-up.png",
                    "PARA. Siéntate. Cuenta al grupo en voz alta. Tres respiraciones lentas que se oigan. Agua si tragan sentados. Luego nombra el problema de verdad: sangrado, agua, techo, perdido, y abre esa tarjeta. No corras. No se partan. Baja el corazón primero o la siguiente milla es un círculo.",
                    "Un corazón rápido hace un mapa rápido y malo. Sentarse es un oficio.",
                    "Dale al niño el trabajo de contar. No es el público del pánico.",
                    "Para de gritar nombres a la oscuridad. Siéntate, cuenta, luego formar si falta alguien.",
                    tick_s=60,
                    party={"1": "Sit, breathe, name the card.", "2": "One sits the panicked, one counts.", "4": "Count / breathe / name / no split."},
                ),
            ],
        ),
        card(
            ...
            "tactics",
            "Sleep is a tool",
            "Dormir es una herramienta",
            "The party has walked into the night on purpose. Tomorrow's water and fire need a brain that still works.",
            "El grupo caminó a la noche a propósito. El agua y el fuego de mañana necesitan un cerebro que aún sirve.",
            [
                ("Watches are set and the cold or heat is already on its card.", "Hay turnos y el frío o el calor ya está en su tarjeta."),
                ("Someone will not wake — that is care, not a nap lecture.", "Alguien no despierta: es cuidado, no una lección de siesta."),
            ],
            "Exhaustion is how people fall on scree and miss the wash. Care if they will not wake. The night-watch card is the animals.",
            "El agotamiento es cómo se cae en el pedregal y se pierde el arroyo. Cuidado si no despiertan. La vigilia es los animales.",
            [
                step(
                    "Roof and floor first, then watches if animals or fire weather need them. The tired walk at 03:00 is how you miss the cut. Split sleep. Eat what you already trust before the long dark if you can swallow. Do not push 'one more ridge' when speech is already stupid.",
                    "A brain without sleep invents shortcuts. The ground does not.",
                    "Child sleeps in the middle, off the dirt. Not a watch.",
                    "Stop the night march that is only pride. Roof, then sun.",
                    "form-up.png",
                    "Techo y piso primero, luego turnos si hay animales o clima de fuego. El caminar cansado a las 03:00 es cómo se pierde la quebrada. Reparte el sueño. Come lo que ya confías antes de la oscuridad larga si puedes tragar. No empujes 'un filo más' cuando el habla ya es tonta.",
                    "Un cerebro sin sueño inventa atajos. El suelo no.",
                    "El niño duerme al centro, fuera de la tierra. No de vigilia.",
                    "Para la marcha nocturna que es solo orgullo. Techo, luego sol.",
                    party={"1": "Roof, then sleep.", "2": "Shifts if the night needs a watch.", "4": "Roof / floor / watch / sleep in pairs."},
                ),
            ],
        ),
        card(
            "camp-light",
            "tactics",
            "Save the battery for a window",
            "Guarda la batería para una ventana",
            "The phone is the map, the light, and maybe a signal. It is also a dead brick by morning.",
            "El teléfono es el mapa, la luz y tal vez una señal. También es un ladrillo muerto por la mañana.",
            [
                ("You have a dedicated light and the phone is off until you need the pack map.", "Tienes una luz aparte y el teléfono está apagado hasta el mapa del pack."),
                ("You are under a fire that a beam would spread — move first.", "Hay un fuego que un haz puede extender: muévete primero."),
            ],
            "A dead phone is a lost map. Signaling still wants a real window. Care does not wait on a torch.",
            "Un teléfono muerto es un mapa perdido. Señalar aún quiere una ventana de verdad. El cuidado no espera una linterna.",
            [
                step(
                    "Red or low if you must. One person on the beam, not four. Fire for camp light if the grass will take it — mineral soil, kill method in hand. Save SEARCH and the pack map for a sit, not a walk-and-scroll. At night the locate card is sit, not a brighter screen.",
                    "The battery is a finite signal. Walking light is how it dies before the window.",
                    "Child does not play the screen. Whistle, not a game.",
                    "Stop the all-night lamp on a tarp. Watch fire, or sit in the dark you can still hear.",
                    "signal-three.png",
                    "Rojo o bajo si debes. Una persona con el haz, no cuatro. Fuego para luz de campo si el pasto lo aguanta: suelo mineral, cómo matarlo en la mano. Guarda SEARCH y el mapa del pack para un sentarte, no un caminar-y-deslizar. De noche la tarjeta de localizar es sentarse, no una pantalla más brillante.",
                    "La batería es una señal finita. Luz de caminar es cómo muere antes de la ventana.",
                    "El niño no juega con la pantalla. Silbato, no un juego.",
                    "Para la lámpara toda la noche en la lona. Vigila el fuego, o siéntate en la oscuridad que aún oyes.",
                    party={"1": "One beam, then off.", "2": "One light, one on the fire or the watch.", "4": "Light / fire / watch / phone for the map sit."},
                ),
            ],
        ),
        card(
            "med-booze",
            "medical",
            "Booze does not warm you",
            "El alcohol no te calienta",
            "Someone wants a drink to sleep, to warm up, or to 'take the edge off' in the heat.",
            "Alguien quiere un trago para dormir, para calentarse o para 'quitar el filo' en el calor.",
            [
                ("The bottle stays closed and they are sipping water.", "La botella se queda cerrada y sorben agua."),
                ("They will not wake or cannot protect an airway — that is the airway card.", "No despiertan o no pueden proteger la vía aérea: es la tarjeta de vía aérea."),
            ],
            "Alcohol dumps heat and steals water. Care for a person who will not wake. It is not treatment.",
            "El alcohol tira calor y roba agua. Cuidado si no despiertan. No es un tratamiento.",
            [
                step(
                    "No. It does not warm you — it opens the pipes in the skin and dumps the trunk. It does not cool you in the white hours — it steals the sip you needed. Water, shade or a bag, then the trunk card. Do not mix it with a head injury or a snake bite.",
                    "A flush feels like heat. It is a leak. Thirst plus booze is the gut and heat cards together.",
                    "Child does not get a 'sip to try'. Ever.",
                    "Stop pouring it into a shivering person. Dry, bag, sit.",
                    "cold-rewarm.png",
                    "No. No te calienta: abre los caños de la piel y tira el tronco. No te enfría en las horas blancas: te roba el sorbo que necesitabas. Agua, sombra o bolsa, luego la tarjeta del tronco. No lo mezcles con un golpe en la cabeza o una mordedura.",
                    "El rubor parece calor. Es una fuga. Sed más alcohol son las tarjetas de estómago y calor juntas.",
                    "El niño no prueba un sorbo. Nunca.",
                    "Para de echárselo a alguien que tiembla. Seca, bolsa, sienta.",
                    party={"1": "Water, not booze.", "2": "One takes the bottle, one does the trunk card.", "4": "Bottle away / water / shade or bag / watch airway."},
                ),
            ],
        ),
        card(
            ...
            "tactics",
            "Rest-step the climb",
            "Paso de descanso en la subida",
            "The slope is long and the party is already blowing. Thin air or just a bad hill in this pack.",
            "La ladera es larga y el grupo ya sopla. Aire fino o solo un cerro malo en este pack.",
            [
                ("The hill is behind you and speech is normal.", "El cerro quedó atrás y el habla es normal."),
                ("Chest pain, a wet cough, or they cannot stand — sit, then the altitude or carry card.", "Dolor de pecho, tos húmeda o no se paran: sienta, luego altitud o acarreo."),
            ],
            "A blown party falls. The altitude card is thin air. Care if they do not recover sitting.",
            "Un grupo reventado se cae. La tarjeta de altitud es el aire fino. Cuidado si no se recuperan sentados.",
            [
                step(
                    "Full lock on the downhill leg, pause, then the next step. Rest-step. Breathe on a rhythm you can keep with a pack. Do not sprint the last pitch. If speech goes stupid, sit. High country: this plus the altitude card. Child matches the slowest adult, not the eager one.",
                    "Momentum on a climb is borrowed. The lock is a free rest every step.",
                    "Child beside the slow adult. No races to the saddle.",
                    "Stop the 'I'll catch my breath at the top'. The top is where people fall.",
                    "ice-rock.png",
                    "Bloqueo completo en la pierna de abajo, pausa, luego el siguiente paso. Paso de descanso. Respira en un ritmo que aguantes con mochila. No sprints el último largo. Si el habla se pone tonta, siéntate. Alta montaña: esto más la tarjeta de altitud. El niño al ritmo del adulto más lento, no del entusiasta.",
                    "El ímpetu en una subida es prestado. El bloqueo es un descanso gratis en cada paso.",
                    "El niño junto al adulto lento. Sin carreras al collado.",
                    "Para el 'tomo aire arriba'. Arriba es donde la gente se cae.",
                    party={"1": "Lock, pause, step.", "2": "Match the slow.", "4": "Slow / count / water / no summit sprint."},
                ),
            ],
        ),
        card(
            ...
            "Despensa que ya tienes",
            "A house, a barn, a kit bag. Cans and dry goods you already own. Not a forage, not a hunt, not a stranger's kitchen.",
            "Una casa, un granero, una bolsa de kit. Latas y seco que ya son tuyos. No es forrajeo, no es caza, no es la cocina de un extraño.",
            [
                ("The can is commercial, sealed, and undamaged.", "La lata es comercial, sellada e intacta."),
                ("The can is bulging or the food is a mystery plant — leave it.", "La lata está abombada o la comida es una planta misteriosa: déjala."),
            ],
            "Gut illness is care if they cannot keep fluids down. This card does not unlock a raid or a wild plant.",
            "El mal de estómago va a cuidado si no retienen líquidos. Esta tarjeta no desbloquea un saqueo ni una planta silvestre.",
            [
                step(
                    "Eat what is already in the kit or the house you already occupy. Sealed cans, rice, beans — then the cook card. Do not chew a yard plant 'because the pantry is low'. Do not treat a closed store as your pantry. If you did not bring it or own it, it is not this card.",
                    "Calories you already trust beat a maybe in the brush. A raid is not fieldcraft.",
                    "Child eats the fully cooked known food. No 'tiny taste' of the yard.",
                    "Stop at a bulging can or a smell like death. Leave it.",
                    "food-boil.png",
                    "Come lo que ya está en el kit o en la casa que ya ocupas. Latas selladas, arroz, frijoles: luego la tarjeta de cocina. No mastiques una planta del patio 'porque la despensa está baja'. No trates una tienda cerrada como tu despensa. Si no lo trajiste o no es tuyo, no es esta tarjeta.",
                    "La caloría que ya confías gana a un quizás en el matorral. Un saqueo no es oficio de campo.",
                    "El niño come la comida conocida bien cocida. Sin probadita del patio.",
                    "Para en una lata abombada o un olor a muerte. Déjala.",
                    party={"1": "Known food, then cook.", "2": "One cooks, one watches the boil.", "4": "Known / cook / water / no yard plants."},
                ),
            ],
        ),
        card(
            "nav-compass",
            "nav",
            "Compass on this pack's map",
            "Brújula en el mapa de este pack",
            "You have a compass and the offline map. The trail is gone. Magnetic vs true lives in INSTRUMENTS.",
            "Tienes brújula y el mapa offline. Se acabó el sendero. Magnética contra verdadera vive en INSTRUMENTS.",
            [
                ("You can see the named handrail you shot.", "Ves la baranda con nombre que tiraste."),
                ("The needle is spinning or you have two 'I'm sure' bearings — sit.", "La aguja gira o hay dos rumbos 'estoy seguro': siéntate."),
            ],
            "A bearing you did not write is a story. Care is the last known road. INSTRUMENTS holds MAG/TRUE.",
            "Un rumbo que no escribiste es un cuento. El cuidado es el último camino conocido. INSTRUMENTS tiene MAG/TRUE.",
            [
                step(
                    "Sit. MAG/TRUE is in INSTRUMENTS, not a guess. Shoot a named line on this pack — a road, a river, a ridge — and walk it. Check the needle at each rest. Do not follow a feeling between checks. If GPS is a maybe, the compass plus the pack map is the honest pair. Steel on the hip throws the needle — hold it away.",
                    "The pack is the map. The compass is a tool on that map. Together they are not a vibe.",
                    "Child does not hold the only compass as a toy.",
                    "Stop if two needles or two people disagree. Sit on the locate card.",
                    "nav-stop.png",
                    "Siéntate. MAG/TRUE está en INSTRUMENTS, no en un palpite. Tira una línea con nombre de este pack: camino, río, filo, y camínala. Mira la aguja en cada descanso. No sigas un presentimiento entre chequeos. Si el GPS es un quizás, brújula más mapa del pack es el par honesto. El acero en la cadera tuerce la aguja: aléjala.",
                    "El pack es el mapa. La brújula es una herramienta sobre ese mapa. Juntas no son una vibra.",
                    "El niño no sostiene la única brújula de juguete.",
                    "Para si hay dos agujas o dos personas en desacuerdo. Siéntate en localizar.",
                    party={"1": "Named line, written bearing.", "2": "One shoots, one walks, check at rests.", "4": "Shoot / walk / child / no split."},
                ),
            ],
        ),
        card(
            "fire-bow",
            "fire",
            "Bow or hand drill last",
            "Arco o taladro de mano al último",
            "You have no ferro, no match, no lens, no battery. Friction is the remaining spark and daylight is leaving.",
            "No hay ferro, fósforo, lupa ni batería. La fricción es la chispa que queda y se acaba el día.",
            [
                ("You already have a coal from a spark you trust.", "Ya tienes una brasa de una chispa que confías."),
                ("Rain is a pour — roof first, this card is a dry-day last resort.", "La lluvia es un chaparrón: techo primero, esta tarjeta es último recurso de día seco."),
            ],
            "Friction fails when wet, rushed, or new. Burns still go to care. Do not spend the last daylight on it unless you already can.",
            "La fricción falla mojada, de prisa o nueva. Las quemaduras van a cuidado. No gastes la última luz del día en eso salvo que ya sepas.",
            [
                step(
                    "Roof and tinder nest first. Dry spindle on dry hearth, notch, bow if you have cordage, hand drill if you do not. Coal into the nest, blow low. If you have not done this when you were fed and calm, you will not invent it hungry at dusk — build the roof and wait for a lens at noon, or walk a handrail while there is light. Last daylight belongs to shelter, not a maybe coal.",
                    "A coal is a skill. Hunger and pride are not a tutorial.",
                    "Child shreds the nest well back. They do not spin the drill.",
                    "Stop when the light is going and there is no coal. Roof. The fire-spark card names the better order.",
                    "fire-ring.png",
                    "Techo y nido primero. Huso seco en hogar seco, muesca, arco si hay cuerda, taladro de mano si no. Brasa al nido, sopla bajo. Si no lo has hecho harto y calmado, no lo vas a inventar con hambre al anochecer: haz el techo y espera una lupa al mediodía, o camina una baranda mientras hay luz. La última luz es del refugio, no de una brasa quizás.",
                    "Una brasa es un oficio. El hambre y el orgullo no son un tutorial.",
                    "El niño desmenuza el nido bien atrás. No gira el taladro.",
                    "Para cuando se va la luz y no hay brasa. Techo. La tarjeta de chispa nombra el mejor orden.",
                    party={"1": "Roof first. Friction only if you already can.", "2": "One drills, one tends the nest and the kill pile.", "4": "Roof / nest / drill / watch the light."},
                ),
            ],
        ),
        card(
            "water-salt",
            "water",
            "Salt in the heat, then water",
            "Sal en el calor, luego agua",
            "Hard work in the sun, cramps, or a bottle that is only water after hours of sweat.",
            "Trabajo duro al sol, calambres o una botella que es solo agua después de horas de sudor.",
            [
                ("They are sipping, making urine, and the cramp is easing.", "Sorben, orinan y el calambre afloja."),
                ("Confusion or they stopped sweating — heat collapse, not a salt pinch.", "Confusión o dejaron de sudar: colapso por calor, no una pizca de sal."),
            ],
            "Salt is not treatment for heat stroke. Cool first if they are already wrong. Care for confusion.",
            "La sal no es tratamiento del golpe de calor. Enfría primero si ya están mal. Cuidado si hay confusión.",
            [
                step(
                    "If they can sit and talk: pinch of salt in treated water, sip, shade. Food you already trust that is not dry crackers in the white hours. Cramps after a long sweat are this card. Stupid speech or no sweat is heat collapse — cool, do not force salt. Do not swallow a handful of dry salt.",
                    "Sweat spends salt. Replacing only water can cramp. Replacing salt in a confused person does not cool the brain.",
                    "Child gets sips in shade, not a salt lick.",
                    "Stop the salt if they vomit or cannot sit. Cool, then the heat card.",
                    "heat-cool.png",
                    "Si se sientan y hablan: pizca de sal en agua tratada, sorbo, sombra. Comida que ya confías que no sea galleta seca en las horas blancas. Los calambres después de un sudor largo son esta tarjeta. Habla tonta o sin sudor es colapso: enfría, no fuerces sal. No tragues un puño de sal seca.",
                    "El sudor gasta sal. Reponer solo agua puede calambrar. Reponer sal en alguien confundido no enfría el cerebro.",
                    "El niño sorbos a la sombra, no un bloque de sal.",
                    "Para la sal si vomitan o no se sientan. Enfría, luego la tarjeta de calor.",
                    party={"1": "Shade, sip, pinch in the bottle.", "2": "One sips them, one treats the next bottle.", "4": "Shade / sips / salt in water / watch speech."},
                ),
            ],
        ),
        card(
            "tact-staygo",
            "tactics",
            "Stay put or walk a named line",
            "Quédate o camina una línea con nombre",
            "The party disagrees. Stay for a search, walk from a fire, climb from a wash. The wrong one kills.",
            "El grupo no está de acuerdo. Quedarse por una búsqueda, caminar de un fuego, subir de un arroyo. El equivocado mata.",
            [
                ("You already picked the matching card and the party is on it.", "Ya eligieron la tarjeta que corresponde y el grupo está en ella."),
                ("Someone is missing at night — form-up first, then this.", "Falta alguien de noche: formar primero, luego esto."),
            ],
            "Lost: sit. Fire: already-burned or a road. Flood: high ground. Care is the last known place, not a debate.",
            "Perdido: siéntate. Fuego: ya quemado o un camino. Creciente: alto. El cuidado es el último lugar conocido, no un debate.",
            [
                step(
                    "Name the threat out loud. Lost or a search looking for you — stay, signal, the locate card. Wildfire — walk perpendicular to the wind toward black, road, or water. Wash talking — out of the cut now. Heat — shade, do not march the white hours. Then one named line, no split. The breathe card if the argument is the emergency.",
                    "Stay and go are both right for different deaths. The threat picks, not the loudest person.",
                    "Child stays attached to one adult. Not a vote.",
                    "Stop the split 'I'll just check over there'. One party, one card.",
                    "form-up.png",
                    "Nombra la amenaza en voz alta. Perdido o una búsqueda que te busca: quédate, señala, la tarjeta de localizar. Incendio: camina perpendicular al viento hacia negro, camino o agua. Arroyo que habla: sal de la quebrada ahora. Calor: sombra, no marches las horas blancas. Luego una línea con nombre, sin partirse. La tarjeta de respirar si la discusión es la emergencia.",
                    "Quedarse y irse son ambos correctos para muertes distintas. La amenaza elige, no el más ruidoso.",
                    "El niño pegado a un adulto. No es un voto.",
                    "Para el 'yo solo miro allá'. Un grupo, una tarjeta.",
                    party={"1": "Name the threat, then that card.", "2": "One names, one keeps the party from splitting.", "4": "Threat / matching card / child / no split."},
                ),
            ],
        ),
    ]
...
def write_all() -> None:
    core = core_cards() + thickness_core() + from_nothing_core() + craft_core() + manual_core()
