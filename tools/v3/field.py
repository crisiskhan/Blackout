...
def thickness_state() -> list[dict]:
    ...
    trees = [
        (
            ...
            "You are in West Texas woodland, park, or bosque. Live oak, pecan, mesquite, cedar elm, cottonwood. Shade, thorns, deadfall.",
            "Estás en arbolado, parque o bosque del oeste de Texas. Encino, pecán, mezquite, olmo cedro, álamo. Sombra, espinas, madera muerta.",
        ...
        (
            ...
            "You are in bosque. Rio Grande cottonwood, juniper, piñon, or aspen. Shade and wind. Piñon is not a Field meal ticket.",
            "Estás en bosque. Álamo del Río Grande, enebro, piñón o álamo temblón. Sombra y viento. El piñón no es un ticket de comida de Field.",
        ...
        (
            ...
            "You are in East Texas woodland, park, or Lost Pines. Live oak, pecan, cedar elm, loblolly pine, cottonwood. Shade and deadfall.",
            "Estás en arbolado, parque o Lost Pines del este de Texas. Encino, pecán, olmo cedro, pino taeda, álamo. Sombra y madera muerta.",
            "If they chewed seed or sap is in both eyes, this is care now, not a use card.",
            "Si masticaron semilla o hay savia en los ojos, esto es cuidado ahora, no una tarjeta de uso.",
        ),
    ]
