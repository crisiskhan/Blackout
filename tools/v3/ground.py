...
# Cerros El Sabinoso is a named peak on that sheet — rank 1
# still beats the overlay.
# Do not add matcher `gato`, `loma el gato`, `contrabando`, or `sabinoso`. Phrase `national preserve`, not the word
# `preserve`. San Antonio Mountain is a named peak on
# Valles Caldera — rank 1 still beats the overlay. Cerro
# Grande is a named peak on that sheet — rank 1 still
# beats the overlay. Rabbit Mountain is a named peak on
...
# management unit is range. Waste Management Wildlife Park is Held
# as Open reserve. Phrase `ecological research`, not the word `research`.
...
# Commission sheets stay their own. Whitfield Wildlife
# Conservation Area is Held at 34.668435, −106.739598 —
# phrase `wildlife conservation area`, not the word
# `whitfield`. Unique versus State Game Commission Land.
# Never edible. Phrase `nature preserve` already matches Charlie
...
# National Wildlife Refuge. San Andres Peak is a named peak
...
# on that sheet — rank 1 still beats the overlay. Cerro
# Grande is a named peak on that sheet — rank 1 still
# beats the overlay. Rabbit Mountain is a named peak on
# that sheet — rank 1 still beats the overlay. Do not add
# matcher `san antonio`, `cerro grande`, or `rabbit`.
# Whiteface Mountain is a named peak on Sevilleta —
...
# Wilderness, Sandia Mountain Wilderness, Organ Mountains-Desert
