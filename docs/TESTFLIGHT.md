...
- `34745805359` (`adfb764`): HUD tag `tf-99`. macos-15 / Xcode 26.3. `HAS_LOCAL_DIST_KEY=1`. `exportArchive OK`. CPV **99**. Dist `66KB44VS8G` (`DISTRIBUTION`). KEEP `45YLWHL6UP` untouched. altool `UPLOAD SUCCEEDED with no errors`. `WAIT no build 99`, then ASC `960c7bd3-fe7e-47a2-a5dc-55c53ae9db55` **VALID**. PATCH 200. `ASSIGN Internal 99 204`. `usesNonExemptEncryption: null`. Live instruments, SPEAK street vertices, unique leftover Holds. Historical — scoring tip is **116**.
