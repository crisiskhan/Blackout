...
- [ ] PASS / FAIL / N/A — Hold a silver glasshouse outline (walking zoom; no class label). Klass Glasshouse. `FIELD · PLANT` opens `tx-plant-danger` (pretty is not food), not tree-use, not plant-use. SPEAK names oleander. Never edible. No animal icon. TX EAST named `Vickery Wholesale Greenhouse` 30.313936, −97.617562. TX WEST unnamed 32.502967, −106.933833. Farmland still Klass Irrigated ground.
