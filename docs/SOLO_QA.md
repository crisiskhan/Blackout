...
- [ ] PASS / FAIL / N/A — Hold a silver glasshouse outline (walking zoom; no class label). Klass Glasshouse. `FIELD · PLANT` opens `tx-plant-danger` (pretty is not food), not tree-use. SPEAK names oleander. Never edible. No animal icon. TX EAST named `Vickery Wholesale Greenhouse` 30.313936, −97.617562. TX WEST unnamed 32.502967, −106.933833. Farmland still Klass Irrigated ground.
- [ ] PASS / FAIL / N/A — Hold a botanic garden or conservatory (silver outline at walking zoom, not Conservatory At North Austin). Klass Botanic garden. `FIELD · PLANT` opens plant-danger (pretty is not food), not tree-use, not cactus. TX SPEAK names oleander. NM plant-danger SPEAK names datura, not jumping cholla. Never edible. NM `Albuquerque BioPark Botanic Garden` 35.094694, −106.682101. NM `Barelas Community Garden` 35.078118, −106.653090. TX WEST `Rose Garden`. `Conservatory At North Austin` stays Built-up ground. `Cactus Point Park` stays Park. `Moontower Saloon Beer Garden` stays Park.
