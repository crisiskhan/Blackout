...
- [ ] PASS / FAIL / N/A — Hold a botanic garden or conservatory (silver outline at walking zoom, not Conservatory At North Austin). Klass Botanic garden. `FIELD · PLANT` opens plant-danger (pretty is not food), not tree-use. Never edible. NM `Albuquerque BioPark Botanic Garden` 35.094694, −106.682101. TX WEST `Chihuahuan Desert Conservatory` 33.150801, −107.238341. TX WEST `Three Crosses Cactus Garden` 32.332056, −106.782048. `Conservatory At North Austin` stays Built-up ground. `Cactus Point Park` stays Park.
