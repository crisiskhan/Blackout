...
- [ ] PASS / FAIL / N/A — Hold a wildlife management area (silver outline at walking zoom, not Wildlife Drive). Klass Wildlife range. `FIELD · ANIMAL`. Range, not a pin. NM `Marquez Wildlife Management Area` 35.327562, −107.319389. `Wildlife Drive Park` stays Park / `FIELD · PLANT`. Never edible. No animal icon.
