...
- [ ] PASS / FAIL / N/A — Hold a cave preserve (silver outline at walking zoom, not Bee Cave). Klass Cave or hole. `FIELD · CAVE` then `NEXT · COLD`. TX EAST `Discovery Well Cave Preserve` 30.490167, −97.856308. `Bee Cave Central Park` stays Park / `FIELD · PLANT`. Never edible. No tourist cave guide.
