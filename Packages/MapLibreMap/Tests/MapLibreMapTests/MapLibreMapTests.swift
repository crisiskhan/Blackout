...
final class MapLibreMapTests: XCTestCase {
    ...
    func testPackCameraFitsPackBBoxNotZoom13Center() {
        ...
        XCTAssertEqual(PackCamera.godsEyeDistance(radiusMeters: radius), radius * 1.6, accuracy: 0.01)
        XCTAssertEqual(PackCamera.godsEyeDistance(radiusMeters: 1000), 1600, accuracy: 0.01)
    ...
    func testPackCameraHoldsGodsEyeOverDestAndYou() {
        ...
        XCTAssertEqual(PackStyle.resolverVersion, 13)
