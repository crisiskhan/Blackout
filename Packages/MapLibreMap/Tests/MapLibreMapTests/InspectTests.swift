...
final class InspectTests: XCTestCase {
    ...
    func testACavePreserveIsAHoleAndBeeCaveIsAPark() {
        ...
        let hotSprings = Inspect.read(
            tags: ["natural": "cave_entrance", "name": "Hot Springs Cave"],
            pack: "nm"
        )
        XCTAssertEqual(hotSprings.klass, "Cave or hole")
        XCTAssertNotEqual(hotSprings.klass, "Open reserve")
        XCTAssertNotEqual(hotSprings.klass, "Rock")
        XCTAssertEqual(hotSprings.fieldRoute.first, Inspect.caveCard)
        XCTAssertFalse(hotSprings.doLine.lowercased().contains("edible"), hotSprings.doLine)

        let sodaDam = Inspect.read(
            tags: ["natural": "bare_rock", "name": "Soda Dam"],
            pack: "nm"
        )
        XCTAssertEqual(sodaDam.klass, "Rock")
        XCTAssertNotEqual(sodaDam.klass, "Cave or hole")
        XCTAssertFalse(sodaDam.fieldRoute.contains(Inspect.caveCard))

        let jemez = Inspect.read(
            tags: [
                "leisure": "nature_reserve",
                "boundary": "protected_area",
                "name": "Jemez National Recreation Area",
            ],
            pack: "nm"
        )
        XCTAssertEqual(jemez.klass, "Open reserve")
        XCTAssertFalse(jemez.fieldRoute.contains(Inspect.caveCard))
        ...
        XCTAssertNotEqual(westsidePreserve.klass, "Cave or hole")
        XCTAssertFalse(westsidePreserve.fieldRoute.contains(Inspect.caveCard))
        XCTAssertEqual(westsidePreserve.fieldRoute.first, Inspect.snakeEastCard)
        XCTAssertFalse(westsidePreserve.doLine.lowercased().contains("edible"), westsidePreserve.doLine)
        ...
        let goodFriday = Inspect.read(
            tags: ["natural": "cave_entrance", "name": "Good Friday"],
            pack: "tx-east"
        )
        XCTAssertEqual(goodFriday.klass, "Cave or hole")
        ...
        let diesRanch = Inspect.read(
            tags: ["natural": "cave_entrance", "name": "Dies Ranch Treasure Cave"],
            pack: "tx-east"
        )
        XCTAssertEqual(diesRanch.klass, "Cave or hole")
        XCTAssertEqual(diesRanch.fieldRoute.first, Inspect.caveCard)
        XCTAssertFalse(diesRanch.doLine.lowercased().contains("edible"), diesRanch.doLine)

        let gholsonDrive = Inspect.read(
            tags: ["highway": "residential", "name": "Gholson Drive"],
            pack: "tx-east"
        )
        XCTAssertEqual(gholsonDrive.klass, "Road")
        XCTAssertFalse(gholsonDrive.fieldRoute.contains(Inspect.caveCard))

        let cypressCanyon = Inspect.read(
            tags: ["leisure": "park", "name": "Cypress Canyon Park"],
            pack: "tx-east"
        )
        XCTAssertEqual(cypressCanyon.klass, "Park")
        XCTAssertFalse(cypressCanyon.fieldRoute.contains(Inspect.caveCard))
    ...
    func testAWildlifeManagementAreaIsRangeNotAPin() {
        ...
        let cerroGrande = Inspect.read(
            tags: ["natural": "peak", "name": "Cerro Grande"],
            state: "NM",
            pack: "nm"
        )
        XCTAssertEqual(cerroGrande.klass, "Peak")
        XCTAssertNotEqual(cerroGrande.klass, "Wildlife range")
        XCTAssertTrue(cerroGrande.fieldRoute.contains(Inspect.mammalNMCard))
        XCTAssertTrue(
            cerroGrande.doLine.lowercased().contains("black bear and elk range"),
            cerroGrande.doLine
        )
        XCTAssertFalse(cerroGrande.doLine.lowercased().contains("javelina"), cerroGrande.doLine)
        XCTAssertFalse(cerroGrande.doLine.lowercased().contains("hog"), cerroGrande.doLine)
        XCTAssertFalse(cerroGrande.doLine.lowercased().contains("edible"), cerroGrande.doLine)

        let rabbitMountain = Inspect.read(
            tags: ["natural": "peak", "name": "Rabbit Mountain"],
            state: "NM",
            pack: "nm"
        )
        XCTAssertEqual(rabbitMountain.klass, "Peak")
        XCTAssertNotEqual(rabbitMountain.klass, "Wildlife range")
        XCTAssertTrue(rabbitMountain.fieldRoute.contains(Inspect.mammalNMCard))
        XCTAssertTrue(
            rabbitMountain.doLine.lowercased().contains("black bear and elk range"),
            rabbitMountain.doLine
        )
        XCTAssertFalse(rabbitMountain.doLine.lowercased().contains("javelina"), rabbitMountain.doLine)
        XCTAssertFalse(rabbitMountain.doLine.lowercased().contains("hog"), rabbitMountain.doLine)
        XCTAssertFalse(rabbitMountain.doLine.lowercased().contains("edible"), rabbitMountain.doLine)

        let whitefaceMountain = Inspect.read(
            tags: ["natural": "peak", "name": "Whiteface Mountain"],
            state: "NM",
            pack: "nm"
        )
        XCTAssertEqual(whitefaceMountain.klass, "Peak")
        XCTAssertNotEqual(whitefaceMountain.klass, "Wildlife range")
        XCTAssertTrue(whitefaceMountain.fieldRoute.contains(Inspect.mammalNMCard))
        XCTAssertTrue(
            whitefaceMountain.doLine.lowercased().contains("black bear and elk range"),
            whitefaceMountain.doLine
        )
        XCTAssertFalse(whitefaceMountain.doLine.lowercased().contains("javelina"), whitefaceMountain.doLine)
        XCTAssertFalse(whitefaceMountain.doLine.lowercased().contains("hog"), whitefaceMountain.doLine)
        XCTAssertFalse(whitefaceMountain.doLine.lowercased().contains("edible"), whitefaceMountain.doLine)

        let sierraLadronesPeak = Inspect.read(
            tags: ["natural": "peak", "name": "Sierra Ladrones"],
            state: "NM",
            pack: "nm"
        )
        XCTAssertEqual(sierraLadronesPeak.klass, "Peak")
        XCTAssertNotEqual(sierraLadronesPeak.klass, "Wildlife range")
        XCTAssertNotEqual(sierraLadronesPeak.klass, "Open reserve")
        XCTAssertTrue(sierraLadronesPeak.fieldRoute.contains(Inspect.mammalNMCard))
        XCTAssertTrue(
            sierraLadronesPeak.doLine.lowercased().contains("black bear and elk range"),
            sierraLadronesPeak.doLine
        )
        XCTAssertFalse(sierraLadronesPeak.doLine.lowercased().contains("javelina"), sierraLadronesPeak.doLine)
        XCTAssertFalse(sierraLadronesPeak.doLine.lowercased().contains("hog"), sierraLadronesPeak.doLine)
        XCTAssertFalse(sierraLadronesPeak.doLine.lowercased().contains("edible"), sierraLadronesPeak.doLine)

        let vabmCliff = Inspect.read(
            tags: ["natural": "peak", "name": "VABM Cliff"],
            state: "NM",
            pack: "nm"
        )
        XCTAssertEqual(vabmCliff.klass, "Peak")
        XCTAssertNotEqual(vabmCliff.klass, "Wildlife range")
        XCTAssertTrue(vabmCliff.fieldRoute.contains(Inspect.mammalNMCard))
        XCTAssertTrue(
            vabmCliff.doLine.lowercased().contains("black bear and elk range"),
            vabmCliff.doLine
        )
        XCTAssertFalse(vabmCliff.doLine.lowercased().contains("javelina"), vabmCliff.doLine)
        ...
        XCTAssertEqual(chamisa.klass, "Open reserve")
        XCTAssertNotEqual(chamisa.klass, "Wildlife range")
        XCTAssertEqual(chamisa.fieldRoute.first, Inspect.snakeTXCard)
        XCTAssertTrue(chamisa.fieldRoute.contains(Inspect.snakeNMCard))
        XCTAssertFalse(chamisa.doLine.lowercased().contains("edible"), chamisa.doLine)

        let tapia = Inspect.read(
            tags: [
                "leisure": "nature_reserve",
                "boundary": "protected_area",
        ...
        XCTAssertEqual(tapia.klass, "Open reserve")
        XCTAssertNotEqual(tapia.klass, "Wildlife range")
        XCTAssertEqual(tapia.fieldRoute.first, Inspect.snakeTXCard)
        XCTAssertTrue(tapia.fieldRoute.contains(Inspect.snakeNMCard))
        XCTAssertFalse(tapia.doLine.lowercased().contains("edible"), tapia.doLine)

        let empedrado = Inspect.read(
            tags: [
                "leisure": "nature_reserve",
                "boundary": "protected_area",
        ...
        XCTAssertEqual(empedrado.klass, "Open reserve")
        XCTAssertNotEqual(empedrado.klass, "Wildlife range")
        XCTAssertEqual(empedrado.fieldRoute.first, Inspect.snakeTXCard)
        XCTAssertTrue(empedrado.fieldRoute.contains(Inspect.snakeNMCard))
        XCTAssertFalse(empedrado.doLine.lowercased().contains("edible"), empedrado.doLine)

        let ignacio = Inspect.read(
            tags: [
                "leisure": "nature_reserve",
                "boundary": "protected_area",
        ...
        XCTAssertEqual(ignacio.klass, "Open reserve")
        XCTAssertNotEqual(ignacio.klass, "Wildlife range")
        XCTAssertEqual(ignacio.fieldRoute.first, Inspect.snakeTXCard)
        XCTAssertTrue(ignacio.fieldRoute.contains(Inspect.snakeNMCard))
        XCTAssertFalse(ignacio.doLine.lowercased().contains("edible"), ignacio.doLine)

        let laLena = Inspect.read(
            tags: [
                "leisure": "nature_reserve",
                "boundary": "protected_area",
        ...
        XCTAssertEqual(laLena.klass, "Open reserve")
        XCTAssertNotEqual(laLena.klass, "Wildlife range")
        XCTAssertEqual(laLena.fieldRoute.first, Inspect.snakeTXCard)
        XCTAssertTrue(laLena.fieldRoute.contains(Inspect.snakeNMCard))
        XCTAssertFalse(laLena.doLine.lowercased().contains("edible"), laLena.doLine)

        let ladrones = Inspect.read(
            tags: [
                "leisure": "nature_reserve",
                "boundary": "protected_area",
        ...
        XCTAssertEqual(ladrones.klass, "Open reserve")
        XCTAssertNotEqual(ladrones.klass, "Wildlife range")
        XCTAssertNotEqual(ladrones.klass, "Peak")
        XCTAssertEqual(ladrones.fieldRoute.first, Inspect.snakeTXCard)
        XCTAssertTrue(ladrones.fieldRoute.contains(Inspect.snakeNMCard))
        XCTAssertFalse(ladrones.doLine.lowercased().contains("edible"), ladrones.doLine)

        let cerroColorado = Inspect.read(
            tags: ["natural": "peak", "name": "Cerro Colorado"],
            pack: "nm"
        )
        ...
        let bennettMountain = Inspect.read(
            tags: ["natural": "peak", "name": "Bennett Mountain"],
            pack: "tx-west"
        )
        XCTAssertEqual(bennettMountain.klass, "Peak")
        XCTAssertNotEqual(bennettMountain.klass, "Wildlife range")
        XCTAssertTrue(bennettMountain.fieldRoute.contains(Inspect.mammalTXCard))
        XCTAssertTrue(bennettMountain.doLine.lowercased().contains("javelina"), bennettMountain.doLine)
        XCTAssertFalse(bennettMountain.doLine.lowercased().contains("hog"), bennettMountain.doLine)
        XCTAssertFalse(bennettMountain.doLine.lowercased().contains("edible"), bennettMountain.doLine)

        let bigBrushyMountain = Inspect.read(
            tags: ["natural": "peak", "name": "Big Brushy Mountain"],
            pack: "tx-west"
        )
        XCTAssertEqual(bigBrushyMountain.klass, "Peak")
        XCTAssertNotEqual(bigBrushyMountain.klass, "Wildlife range")
        XCTAssertTrue(bigBrushyMountain.fieldRoute.contains(Inspect.mammalTXCard))
        XCTAssertTrue(bigBrushyMountain.doLine.lowercased().contains("javelina"), bigBrushyMountain.doLine)
        XCTAssertFalse(bigBrushyMountain.doLine.lowercased().contains("hog"), bigBrushyMountain.doLine)
        XCTAssertFalse(bigBrushyMountain.doLine.lowercased().contains("edible"), bigBrushyMountain.doLine)

        let gardnerPeak = Inspect.read(
            tags: ["natural": "peak", "name": "Gardner Peak"],
            pack: "tx-west"
        )
        XCTAssertEqual(gardnerPeak.klass, "Peak")
        XCTAssertNotEqual(gardnerPeak.klass, "Wildlife range")
        XCTAssertTrue(gardnerPeak.fieldRoute.contains(Inspect.mammalTXCard))
        XCTAssertTrue(gardnerPeak.doLine.lowercased().contains("javelina"), gardnerPeak.doLine)
        ...
        XCTAssertEqual(cuevas.klass, "Wildlife range")
        XCTAssertNotEqual(cuevas.klass, "Open reserve")
        XCTAssertEqual(cuevas.fieldRoute.first, Inspect.mammalEastCard)
        XCTAssertTrue(cuevas.doLine.lowercased().contains("hog"), cuevas.doLine)
        XCTAssertFalse(cuevas.doLine.lowercased().contains("javelina"), cuevas.doLine)
        XCTAssertFalse(cuevas.doLine.lowercased().contains("edible"), cuevas.doLine)
    ...
    func testAnOpenReserveIsSnakeCountryNotPicnicWoodland() {
        ...
        let indianGrass = Inspect.read(
            tags: ["leisure": "nature_reserve", "name": "Indian Grass Prarie Preserve"],
            pack: "tx-east"
        )
        XCTAssertEqual(indianGrass.klass, "Open reserve")
        XCTAssertNotEqual(indianGrass.klass, "Wildlife range")
        XCTAssertEqual(indianGrass.fieldRoute.first, Inspect.snakeEastCard)
        XCTAssertTrue(indianGrass.doLine.lowercased().contains("cottonmouth"), indianGrass.doLine)
        XCTAssertTrue(indianGrass.doLine.lowercased().contains("hog"), indianGrass.doLine)
        XCTAssertFalse(indianGrass.doLine.lowercased().contains("javelina"), indianGrass.doLine)
        XCTAssertFalse(indianGrass.doLine.lowercased().contains("edible"), indianGrass.doLine)

        let violetCrown = Inspect.read(
            tags: ["highway": "cycleway", "name": "Violet Crown Trail"],
            pack: "tx-east"
        )
        XCTAssertEqual(violetCrown.klass, "Trail")
        XCTAssertNotEqual(violetCrown.klass, "Open reserve")

        let southHills = Inspect.read(
            tags: ["leisure": "nature_reserve", "name": "South Hills Conservation Area"],
            pack: "tx-east"
        )
        XCTAssertEqual(southHills.klass, "Open reserve")
        XCTAssertNotEqual(southHills.klass, "Wildlife range")
        XCTAssertEqual(southHills.fieldRoute.first, Inspect.snakeEastCard)
        XCTAssertTrue(southHills.doLine.lowercased().contains("cottonmouth"), southHills.doLine)
        XCTAssertTrue(southHills.doLine.lowercased().contains("hog"), southHills.doLine)
        ...
        let anthem = Inspect.read(
            tags: ["leisure": "nature_reserve", "name": "Anthem Tract"],
            pack: "tx-east"
        )
        XCTAssertEqual(anthem.klass, "Open reserve")
        XCTAssertNotEqual(anthem.klass, "Wildlife range")
        XCTAssertEqual(anthem.fieldRoute.first, Inspect.snakeEastCard)
        XCTAssertTrue(anthem.doLine.lowercased().contains("cottonmouth"), anthem.doLine)
        XCTAssertTrue(anthem.doLine.lowercased().contains("hog"), anthem.doLine)
        XCTAssertFalse(anthem.doLine.lowercased().contains("javelina"), anthem.doLine)
        XCTAssertFalse(anthem.doLine.lowercased().contains("edible"), anthem.doLine)
        ...
        XCTAssertEqual(oakdale.klass, "Open reserve")
        XCTAssertNotEqual(oakdale.klass, "Wildlife range")
        XCTAssertEqual(oakdale.fieldRoute.first, Inspect.snakeEastCard)
        XCTAssertFalse(oakdale.doLine.lowercased().contains("edible"), oakdale.doLine)

        let oakdaleDrive = Inspect.read(
            tags: ["highway": "residential", "name": "Oakdale Drive"],
            pack: "tx-east"
        )
        XCTAssertEqual(oakdaleDrive.klass, "Road")
        XCTAssertNotEqual(oakdaleDrive.klass, "Open reserve")

        let shudde = Inspect.read(
            tags: ["leisure": "nature_reserve", "name": "Shudde Fath Tract"],
            pack: "tx-east"
        )
        XCTAssertEqual(shudde.klass, "Open reserve")
        XCTAssertEqual(shudde.fieldRoute.first, Inspect.snakeEastCard)
        XCTAssertFalse(shudde.doLine.lowercased().contains("edible"), shudde.doLine)

        let stearns = Inspect.read(
            tags: ["highway": "residential", "name": "Stearns Lane"],
            pack: "tx-east"
        )
        XCTAssertEqual(stearns.klass, "Road")
        XCTAssertNotEqual(stearns.klass, "Open reserve")

        let wastePark = Inspect.read(
            tags: ["leisure": "nature_reserve", "name": "Waste Management Wildlife Park"],
            pack: "tx-east"
        )
        XCTAssertEqual(wastePark.klass, "Open reserve")
        XCTAssertNotEqual(wastePark.klass, "Wildlife range")
        XCTAssertEqual(wastePark.fieldRoute.first, Inspect.snakeEastCard)
        XCTAssertFalse(wastePark.doLine.lowercased().contains("edible"), wastePark.doLine)

        let springdale = Inspect.read(
            tags: ["highway": "tertiary", "name": "Springdale Road"],
            pack: "tx-east"
        )
        XCTAssertEqual(springdale.klass, "Road")
        XCTAssertNotEqual(springdale.klass, "Open reserve")

        let walnutBelt = Inspect.read(
            tags: ["leisure": "nature_reserve", "name": "Southern Walnut Creek Greenbelt"],
            pack: "tx-east"
        )
        XCTAssertEqual(walnutBelt.klass, "Open reserve")
        XCTAssertNotEqual(walnutBelt.klass, "Wildlife range")
        XCTAssertFalse(walnutBelt.doLine.lowercased().contains("edible"), walnutBelt.doLine)

        let walnutTrail = Inspect.read(
            tags: ["highway": "cycleway", "name": "Southern Walnut Creek Trail"],
            pack: "tx-east"
        )
        XCTAssertEqual(walnutTrail.klass, "Trail")
        XCTAssertNotEqual(walnutTrail.klass, "Open reserve")

        let uplands = Inspect.read(
            tags: ["leisure": "nature_reserve", "name": "Uplands"],
            pack: "tx-east"
        )
        XCTAssertEqual(uplands.klass, "Open reserve")
        XCTAssertFalse(uplands.doLine.lowercased().contains("edible"), uplands.doLine)

        let southLamar = Inspect.read(
            tags: ["highway": "secondary", "name": "South Lamar Boulevard"],
            pack: "tx-east"
        )
        XCTAssertEqual(southLamar.klass, "Road")
        XCTAssertNotEqual(southLamar.klass, "Open reserve")

        let westgate = Inspect.read(
            tags: ["leisure": "nature_reserve", "name": "Westgate and Sunset Properties"],
            pack: "tx-east"
        )
        XCTAssertEqual(westgate.klass, "Open reserve")
        XCTAssertNotEqual(westgate.klass, "Wildlife range")
        XCTAssertFalse(westgate.doLine.lowercased().contains("edible"), westgate.doLine)

        let westWind = Inspect.read(
            tags: ["highway": "residential", "name": "West Wind Trail"],
            pack: "tx-east"
        )
        ...
        XCTAssertEqual(cornundas.klass, "Open reserve")
        XCTAssertNotEqual(cornundas.klass, "Peak")
        XCTAssertEqual(cornundas.fieldRoute.first, Inspect.snakeTXCard)
        XCTAssertFalse(cornundas.doLine.lowercased().contains("edible"), cornundas.doLine)

        let cornudasPeak = Inspect.read(
            tags: ["natural": "peak", "name": "Cornudas Mountain"],
            pack: "tx-west"
        )
        XCTAssertEqual(cornudasPeak.klass, "Peak")
        XCTAssertNotEqual(cornudasPeak.klass, "Open reserve")

        let countyF022 = Inspect.read(
            tags: ["highway": "residential", "name": "County Road F022"],
            pack: "tx-west"
        )
        XCTAssertEqual(countyF022.klass, "Road")
        XCTAssertNotEqual(countyF022.klass, "Open reserve")

        let floridaWSA = Inspect.read(
            tags: [
                "leisure": "nature_reserve",
                "boundary": "protected_area",
        ...
        XCTAssertEqual(floridaWSA.klass, "Open reserve")
        XCTAssertNotEqual(floridaWSA.klass, "Wildlife range")
        XCTAssertEqual(floridaWSA.fieldRoute.first, Inspect.snakeTXCard)
        XCTAssertFalse(floridaWSA.doLine.lowercased().contains("edible"), floridaWSA.doLine)

        let organPeaks = Inspect.read(
            tags: [
                "leisure": "nature_reserve",
                "boundary": "national_park",
                "name": "Organ Mountains-Desert Peaks National Monument",
        ...
        XCTAssertEqual(organPeaks.klass, "Open reserve")
        XCTAssertNotEqual(organPeaks.klass, "Wildlife range")
        XCTAssertNotEqual(organPeaks.klass, "Peak")
        XCTAssertEqual(organPeaks.fieldRoute.first, Inspect.snakeTXCard)
        XCTAssertTrue(organPeaks.doLine.lowercased().contains("diamondback"), organPeaks.doLine)
        XCTAssertTrue(organPeaks.doLine.lowercased().contains("javelina"), organPeaks.doLine)
        XCTAssertFalse(organPeaks.doLine.lowercased().contains("edible"), organPeaks.doLine)

        let organWilderness = Inspect.read(
            tags: [
                "leisure": "nature_reserve",
                "boundary": "protected_area",
                "name": "Organ Mountains Wilderness",
            ],
            pack: "tx-west"
        )
        XCTAssertEqual(organWilderness.klass, "Open reserve")
        XCTAssertNotEqual(organWilderness.klass, "Wildlife range")
        XCTAssertEqual(organWilderness.fieldRoute.first, Inspect.snakeTXCard)
        XCTAssertTrue(organWilderness.doLine.lowercased().contains("diamondback"), organWilderness.doLine)
        XCTAssertTrue(organWilderness.doLine.lowercased().contains("javelina"), organWilderness.doLine)
        XCTAssertFalse(organWilderness.doLine.lowercased().contains("edible"), organWilderness.doLine)
        ...
        let embuditoSheet = Inspect.read(
            tags: ["leisure": "park", "name": "High Desert Embudito Open Space"],
            pack: "nm"
        )
        XCTAssertEqual(embuditoSheet.klass, "Open reserve")
        XCTAssertNotEqual(embuditoSheet.klass, "Park")
        XCTAssertFalse(embuditoSheet.doLine.lowercased().contains("edible"), embuditoSheet.doLine)

        let hondoSpace = Inspect.read(
            tags: [
                "leisure": "park",
                "boundary": "protected_area",
                "name": "Arroyo Hondo Open Space",
            ],
            pack: "nm"
        )
        XCTAssertEqual(hondoSpace.klass, "Open reserve")
        XCTAssertNotEqual(hondoSpace.klass, "Park")
        XCTAssertEqual(hondoSpace.fieldRoute.first, Inspect.snakeTXCard)
        XCTAssertTrue(hondoSpace.fieldRoute.contains(Inspect.snakeNMCard))
        XCTAssertFalse(hondoSpace.doLine.lowercased().contains("edible"), hondoSpace.doLine)

        let hondoTrail = Inspect.read(
            tags: ["highway": "bridleway", "name": "Santa Fe County Arroyo Hondo Open Space Trail"],
            pack: "nm"
        )
        XCTAssertEqual(hondoTrail.klass, "Trail")
        XCTAssertNotEqual(hondoTrail.klass, "Open reserve")

        let durandSpace = Inspect.read(
            tags: ["leisure": "park", "name": "Durand Open Space"],
            pack: "nm"
        )
        XCTAssertEqual(durandSpace.klass, "Open reserve")
        XCTAssertNotEqual(durandSpace.klass, "Wildlife range")
        XCTAssertFalse(durandSpace.doLine.lowercased().contains("edible"), durandSpace.doLine)

        let isletaBlvd = Inspect.read(
            tags: ["highway": "secondary", "name": "Isleta Boulevard Southwest"],
            pack: "nm"
        )
        XCTAssertEqual(isletaBlvd.klass, "Road")
        XCTAssertNotEqual(isletaBlvd.klass, "Open reserve")

        let tijerasSpace = Inspect.read(
            tags: ["leisure": "park", "name": "East Tijeras Arroyo Open Space"],
            pack: "nm"
        )
        XCTAssertEqual(tijerasSpace.klass, "Open reserve")
        XCTAssertFalse(tijerasSpace.doLine.lowercased().contains("edible"), tijerasSpace.doLine)

        let fentonPark = Inspect.read(
            tags: [
                "leisure": "nature_reserve",
                "boundary": "protected_area",
        ...
        XCTAssertEqual(fentonPark.klass, "Open reserve")
        XCTAssertNotEqual(fentonPark.klass, "Wildlife range")
        XCTAssertFalse(fentonPark.doLine.lowercased().contains("edible"), fentonPark.doLine)

        let barleyCanyon = Inspect.read(
            tags: ["highway": "track", "name": "Barley Canyon Road"],
            pack: "nm"
        )
        XCTAssertEqual(barleyCanyon.klass, "Track")
        XCTAssertNotEqual(barleyCanyon.klass, "Open reserve")

        let pinoSpace = Inspect.read(
            tags: ["leisure": "park", "name": "Pino Arroyo Open Space"],
            pack: "nm"
        )
        XCTAssertEqual(pinoSpace.klass, "Open reserve")
        XCTAssertNotEqual(pinoSpace.klass, "Park")
        XCTAssertFalse(pinoSpace.doLine.lowercased().contains("edible"), pinoSpace.doLine)

        let quailRun = Inspect.read(
            tags: ["highway": "residential", "name": "Quail Run Court Northeast"],
            pack: "nm"
        )
        XCTAssertEqual(quailRun.klass, "Road")
        XCTAssertNotEqual(quailRun.klass, "Open reserve")

        let santaFeSpace = Inspect.read(
            tags: ["leisure": "park", "name": "Santa Fe Open Space"],
            pack: "nm"
        )
        XCTAssertEqual(santaFeSpace.klass, "Open reserve")
        XCTAssertNotEqual(santaFeSpace.klass, "Park")
        XCTAssertFalse(santaFeSpace.doLine.lowercased().contains("edible"), santaFeSpace.doLine)

        let paseoVista = Inspect.read(
            tags: ["highway": "residential", "name": "Paseo de Vista"],
            pack: "nm"
        )
        XCTAssertEqual(paseoVista.klass, "Road")
        XCTAssertNotEqual(paseoVista.klass, "Open reserve")
        ...
        XCTAssertEqual(bandelier.klass, "Open reserve")
        XCTAssertNotEqual(bandelier.klass, "Wildlife range")
        XCTAssertNotEqual(bandelier.klass, "Cave or hole")
        XCTAssertNotEqual(bandelier.klass, "Peak")
        XCTAssertEqual(bandelier.fieldRoute.first, Inspect.snakeTXCard)
        XCTAssertTrue(bandelier.fieldRoute.contains(Inspect.snakeNMCard))
        XCTAssertFalse(bandelier.doLine.lowercased().contains("edible"), bandelier.doLine)

        let escobas = Inspect.read(
            tags: ["natural": "peak", "name": "Escobas Mesa"],
            pack: "nm"
        )
        XCTAssertEqual(escobas.klass, "Peak")
        XCTAssertNotEqual(escobas.klass, "Open reserve")

        let carlito = Inspect.read(
            tags: ["leisure": "park", "name": "Carlito Springs Open Space"],
            pack: "nm"
        )
        XCTAssertEqual(carlito.klass, "Open reserve")
        XCTAssertNotEqual(carlito.klass, "Park")
        XCTAssertEqual(carlito.fieldRoute.first, Inspect.snakeTXCard)
        XCTAssertTrue(carlito.fieldRoute.contains(Inspect.snakeNMCard))
        XCTAssertFalse(carlito.doLine.lowercased().contains("edible"), carlito.doLine)

        let sedillo = Inspect.read(
            tags: ["leisure": "park", "name": "Sedillo Ridge Open Space"],
            pack: "nm"
        )
        XCTAssertEqual(sedillo.klass, "Open reserve")
        XCTAssertNotEqual(sedillo.klass, "Park")
        XCTAssertEqual(sedillo.fieldRoute.first, Inspect.snakeTXCard)
        XCTAssertFalse(sedillo.doLine.lowercased().contains("edible"), sedillo.doLine)

        let juanTrail = Inspect.read(
            tags: ["highway": "path", "name": "Juan Trail"],
            pack: "nm"
        )
        XCTAssertEqual(juanTrail.klass, "Trail")
        XCTAssertNotEqual(juanTrail.klass, "Open reserve")

        let ponderosa = Inspect.read(
            tags: ["leisure": "park", "name": "Loma Ponderosa Open Space"],
            pack: "nm"
        )
        XCTAssertEqual(ponderosa.klass, "Open reserve")
        XCTAssertNotEqual(ponderosa.klass, "Park")
        XCTAssertFalse(ponderosa.doLine.lowercased().contains("edible"), ponderosa.doLine)

        let sabino = Inspect.read(
            tags: ["leisure": "park", "name": "Sabino Canyon Open Space"],
            pack: "nm"
        )
        XCTAssertEqual(sabino.klass, "Open reserve")
        XCTAssertNotEqual(sabino.klass, "Park")
        XCTAssertFalse(sabino.doLine.lowercased().contains("edible"), sabino.doLine)

        let sabinoTrail = Inspect.read(
            tags: ["highway": "path", "name": "Sabino Canyon East Trail"],
            pack: "nm"
        )
        XCTAssertEqual(sabinoTrail.klass, "Trail")
        XCTAssertNotEqual(sabinoTrail.klass, "Open reserve")

        let gutierrez = Inspect.read(
            tags: ["leisure": "park", "name": "Gutierrez Canyon-Milne Open Space"],
            pack: "nm"
        )
        XCTAssertEqual(gutierrez.klass, "Open reserve")
        XCTAssertNotEqual(gutierrez.klass, "Park")
        XCTAssertFalse(gutierrez.doLine.lowercased().contains("edible"), gutierrez.doLine)

        let canyonTrail = Inspect.read(
            tags: ["highway": "path", "name": "Canyon Trail"],
            pack: "nm"
        )
        XCTAssertEqual(canyonTrail.klass, "Trail")
        XCTAssertNotEqual(canyonTrail.klass, "Open reserve")

        let pistolas = Inspect.read(
            tags: ["leisure": "park", "name": "Tres Pistolas Open Space"],
            pack: "nm"
        )
        XCTAssertEqual(pistolas.klass, "Open reserve")
        XCTAssertNotEqual(pistolas.klass, "Park")
        XCTAssertNotEqual(pistolas.klass, "Wildlife range")
        XCTAssertFalse(pistolas.doLine.lowercased().contains("edible"), pistolas.doLine)

        let hawkSpur = Inspect.read(
            tags: ["highway": "path", "name": "Hawk Watch Connector Spur"],
            pack: "nm"
        )
        XCTAssertEqual(hawkSpur.klass, "Trail")
        XCTAssertNotEqual(hawkSpur.klass, "Open reserve")

        let ojitoSanAntonio = Inspect.read(
            tags: ["leisure": "park", "name": "Ojito de San Antonio Open Space"],
            pack: "nm"
        )
        XCTAssertEqual(ojitoSanAntonio.klass, "Open reserve")
        XCTAssertNotEqual(ojitoSanAntonio.klass, "Park")
        XCTAssertFalse(ojitoSanAntonio.doLine.lowercased().contains("edible"), ojitoSanAntonio.doLine)

        let ojoGrande = Inspect.read(
            tags: ["highway": "residential", "name": "Ojo Grande Drive"],
            pack: "nm"
        )
        XCTAssertEqual(ojoGrande.klass, "Road")
        XCTAssertNotEqual(ojoGrande.klass, "Open reserve")
        ...
        let billyRogers = Inspect.read(
            tags: ["leisure": "nature_reserve", "name": "Billy Rogers Arroyo"],
            pack: "tx-west"
        )
        XCTAssertEqual(billyRogers.klass, "Open reserve")
        XCTAssertNotEqual(billyRogers.klass, "Park")
        XCTAssertEqual(billyRogers.fieldRoute.first, Inspect.snakeTXCard)
        XCTAssertFalse(billyRogers.doLine.lowercased().contains("edible"), billyRogers.doLine)

        let robinsonAve = Inspect.read(
            tags: ["highway": "residential", "name": "East Robinson Avenue"],
            pack: "tx-west"
        )
        XCTAssertEqual(robinsonAve.klass, "Road")
        XCTAssertNotEqual(robinsonAve.klass, "Open reserve")

        let piedmont = Inspect.read(
            tags: ["leisure": "nature_reserve", "name": "Piedmont City Preserve"],
            pack: "tx-west"
        )
        XCTAssertEqual(piedmont.klass, "Open reserve")
        XCTAssertNotEqual(piedmont.klass, "Park")
        XCTAssertFalse(piedmont.doLine.lowercased().contains("edible"), piedmont.doLine)

        let cerroDePaz = Inspect.read(
            tags: ["highway": "service", "name": "Cerro de Paz"],
            pack: "tx-west"
        )
        XCTAssertEqual(cerroDePaz.klass, "Service road")
        XCTAssertNotEqual(cerroDePaz.klass, "Open reserve")

        let northOpen = Inspect.read(
            tags: ["leisure": "nature_reserve", "name": "North Open Reserve"],
            pack: "tx-west"
        )
        XCTAssertEqual(northOpen.klass, "Open reserve")
        XCTAssertNotEqual(northOpen.klass, "Park")
        XCTAssertEqual(northOpen.fieldRoute.first, Inspect.snakeTXCard)
        XCTAssertTrue(northOpen.doLine.lowercased().contains("diamondback"), northOpen.doLine)
        XCTAssertTrue(northOpen.doLine.lowercased().contains("javelina"), northOpen.doLine)
        XCTAssertFalse(northOpen.doLine.lowercased().contains("edible"), northOpen.doLine)

        let ridgeTop = Inspect.read(
            tags: ["highway": "residential", "name": "Ridge Top Drive"],
            pack: "tx-west"
        )
        XCTAssertEqual(ridgeTop.klass, "Road")
        XCTAssertNotEqual(ridgeTop.klass, "Open reserve")

        let southOpen = Inspect.read(
            tags: ["leisure": "nature_reserve", "name": "South Open Reserve"],
            pack: "tx-west"
        )
        XCTAssertEqual(southOpen.klass, "Open reserve")
        XCTAssertNotEqual(southOpen.klass, "Park")
        XCTAssertEqual(southOpen.fieldRoute.first, Inspect.snakeTXCard)
        XCTAssertTrue(southOpen.doLine.lowercased().contains("diamondback"), southOpen.doLine)
        XCTAssertTrue(southOpen.doLine.lowercased().contains("javelina"), southOpen.doLine)
        XCTAssertFalse(southOpen.doLine.lowercased().contains("edible"), southOpen.doLine)

        let alabamaStreet = Inspect.read(
            tags: ["highway": "secondary", "name": "Alabama Street"],
            pack: "tx-west"
        )
        XCTAssertEqual(alabamaStreet.klass, "Road")
        XCTAssertNotEqual(alabamaStreet.klass, "Open reserve")

        let manzanoWSA = Inspect.read(
            tags: [
                "leisure": "nature_reserve",
                "boundary": "protected_area",
        ...
        XCTAssertEqual(manzanoWSA.klass, "Open reserve")
        XCTAssertNotEqual(manzanoWSA.klass, "Wildlife range")
        XCTAssertEqual(manzanoWSA.fieldRoute.first, Inspect.snakeTXCard)
        XCTAssertTrue(manzanoWSA.fieldRoute.contains(Inspect.snakeNMCard))
        XCTAssertFalse(manzanoWSA.doLine.lowercased().contains("edible"), manzanoWSA.doLine)

        let ojitoWSA = Inspect.read(
            tags: [
                "leisure": "nature_reserve",
                "boundary": "protected_area",
        ...
        XCTAssertEqual(ojitoWSA.klass, "Open reserve")
        XCTAssertNotEqual(ojitoWSA.klass, "Wildlife range")
        XCTAssertEqual(ojitoWSA.fieldRoute.first, Inspect.snakeTXCard)
        XCTAssertTrue(ojitoWSA.fieldRoute.contains(Inspect.snakeNMCard))
        XCTAssertFalse(ojitoWSA.doLine.lowercased().contains("edible"), ojitoWSA.doLine)

        let sanLuisMesa = Inspect.read(
            tags: [
                "leisure": "nature_reserve",
                "boundary": "protected_area",
        ...
        XCTAssertEqual(sanLuisMesa.klass, "Open reserve")
        XCTAssertNotEqual(sanLuisMesa.klass, "Wildlife range")
        XCTAssertFalse(sanLuisMesa.doLine.lowercased().contains("edible"), sanLuisMesa.doLine)

        let pecosWilderness = Inspect.read(
            tags: [
                "leisure": "nature_reserve",
                "boundary": "protected_area",
        ...
        XCTAssertEqual(pecosWilderness.klass, "Open reserve")
        XCTAssertNotEqual(pecosWilderness.klass, "Wildlife range")
        XCTAssertFalse(pecosWilderness.doLine.lowercased().contains("edible"), pecosWilderness.doLine)

        let santaFeForest = Inspect.read(
            tags: ["boundary": "protected_area", "name": "Santa Fe National Forest"],
            pack: "nm"
        )
        XCTAssertNotEqual(santaFeForest.klass, "Open reserve")
    ...
    func testANamedTreeIsPlantGroundNotAMeal() {
        ...
        let memorial = Inspect.read(
            tags: ["natural": "tree", "name": "Memorial Tree"],
            state: "TX",
            pack: "tx-east"
        )
        XCTAssertEqual(memorial.klass, "Named tree")
        XCTAssertEqual(memorial.title, "Memorial Tree")
        XCTAssertEqual(memorial.fieldRoute.first, Inspect.treeUseEastCard)
        XCTAssertFalse(memorial.doLine.lowercased().contains("edible"), memorial.doLine)
        XCTAssertTrue(memorial.doLine.lowercased().contains("not a meal"), memorial.doLine)

        let guadalupeStreet = Inspect.read(
            tags: ["highway": "tertiary", "name": "Guadalupe Street"],
            pack: "tx-east"
        )
        XCTAssertEqual(guadalupeStreet.klass, "Road")
        XCTAssertNotEqual(guadalupeStreet.klass, "Named tree")

        let skyview = Inspect.read(
            tags: ["place": "neighbourhood", "name": "Skyview"],
            pack: "tx-east"
        )
        XCTAssertNotEqual(skyview.klass, "Named tree")

        let arbol = Inspect.read(
            tags: ["natural": "tree", "name": "Arbol del dique"],
            state: "TX",
            pack: "tx-west"
        )
        XCTAssertEqual(arbol.klass, "Named tree")
        XCTAssertEqual(arbol.title, "Arbol del dique")
        XCTAssertEqual(arbol.fieldRoute.first, Inspect.treeUseTXCard)
        XCTAssertFalse(arbol.doLine.lowercased().contains("edible"), arbol.doLine)
        XCTAssertTrue(arbol.doLine.lowercased().contains("not a meal"), arbol.doLine)

        let ejeVial = Inspect.read(
            tags: ["highway": "primary", "name": "Eje Vial Juan Gabriel"],
            pack: "tx-west"
        )
        XCTAssertEqual(ejeVial.klass, "Road")
        XCTAssertNotEqual(ejeVial.klass, "Named tree")
    }
    ...
    func testACaveOrPeakUnderTheThumbBeatsTheStreetBesideIt() {
        ...
        XCTAssertEqual(
            Inspect.pick([
                ["natural": "peak", "name": "Bennett Mountain"],
                [
                    "leisure": "nature_reserve",
                    "boundary": "protected_area",
                    "name": "San Andres National Wildlife Refuge",
        ...
        XCTAssertEqual(
            Inspect.pick([
                ["natural": "peak", "name": "Big Brushy Mountain"],
                [
                    "leisure": "nature_reserve",
                    "boundary": "protected_area",
                    "name": "San Andres National Wildlife Refuge",
        ...
        XCTAssertEqual(
            Inspect.pick([
                ["natural": "peak", "name": "Gardner Peak"],
                [
                    "leisure": "nature_reserve",
                    "boundary": "protected_area",
                    "name": "San Andres National Wildlife Refuge",
        ...
        XCTAssertEqual(
            Inspect.pick([
                ["natural": "cave_entrance", "name": "Hot Springs Cave"],
                [
                    "leisure": "nature_reserve",
                    "boundary": "protected_area",
                    "name": "Jemez National Recreation Area",
                ],
                ["natural": "bare_rock", "name": "Soda Dam"],
                ["waterway": "stream", "name": "Jemez River"],
            ])["natural"],
            "cave_entrance"
        )
        XCTAssertEqual(
        ...
        XCTAssertEqual(
            Inspect.pick([
                ["natural": "cave_entrance", "name": "Good Friday"],
                ["leisure": "park", "name": "Buttercup Creek Cave Preserve"],
                ["highway": "residential", "name": "Brook Meadow Trail"],
                ["highway": "residential", "name": "Anna Court"],
                ["highway": "footway", "name": "Cedar Elm Preserve Trail"],
        ...
        // Tap 99 m is outside the 44pt box — do not put drinking_water
        // in this pick. Rank 0 would beat the cave.
        XCTAssertEqual(
            Inspect.pick([
                ["natural": "cave_entrance", "name": "Dies Ranch Treasure Cave"],
                ["leisure": "park", "name": "Cypress Canyon Park"],
                ["highway": "residential", "name": "Gholson Drive"],
            ])["natural"],
            "cave_entrance"
        )
        XCTAssertEqual(
        ...
        XCTAssertEqual(
            Inspect.pick([
                ["natural": "tree", "name": "Memorial Tree"],
                ["highway": "tertiary", "name": "Guadalupe Street"],
                ["place": "neighbourhood", "name": "Skyview"],
            ])["natural"],
            "tree"
        )
        XCTAssertEqual(
            Inspect.pick([
                ["natural": "tree", "name": "Arbol del dique"],
                ["highway": "primary", "name": "Eje Vial Juan Gabriel"],
            ])["natural"],
            "tree"
        )
    }
    ...
    func testAWildlifeSanctuaryBeatsWoodlandAndANamedStreet() {
        ...
        let cuevasSheet: [String: String] = [
            "leisure": "nature_reserve",
            "name": "Balcones Canyonlands Preserve - Cuevas",
        ]
        XCTAssertEqual(Inspect.pick([cuevasSheet])["name"], "Balcones Canyonlands Preserve - Cuevas")
        XCTAssertEqual(
            Inspect.read(tags: Inspect.pick([cuevasSheet]), pack: "tx-east").klass,
            "Wildlife range"
        )
        XCTAssertNotEqual(
            Inspect.pick([cuevasSheet])["name"],
            "Balcones Canyonlands Preserve - Cuevas East"
        )
        let vistaParkeDrive: [String: String] = [
            "highway": "residential",
            "name": "Vista Parke Drive",
        ]
        XCTAssertEqual(Inspect.pick([cuevasSheet, vistaParkeDrive])["leisure"], "nature_reserve")
        XCTAssertEqual(
            Inspect.read(tags: Inspect.pick([cuevasSheet, vistaParkeDrive]), pack: "tx-east").klass,
            "Wildlife range"
        )
    ...
    func testAnOpenReserveBeatsWoodlandAndANamedStreet() {
        ...
        let cornudasPeakTags: [String: String] = [
            "natural": "peak",
            "name": "Cornudas Mountain",
        ]
        let cornundasReserve: [String: String] = [
            "leisure": "nature_reserve",
            "boundary": "protected_area",
            "name": "Cornundas Mountain Area of Critical Environmental Concern",
        ]
        ...
        let bandelierPeakTags: [String: String] = [
            "natural": "peak",
            "name": "Escobas Mesa",
        ]
        let bandelierReserve: [String: String] = [
            "leisure": "nature_reserve",
            "boundary": "national_park",
            "name": "Bandelier National Monument",
        ]
        XCTAssertEqual(Inspect.pick([bandelierPeakTags, bandelierReserve])["natural"], "peak")
        XCTAssertEqual(
            Inspect.read(tags: Inspect.pick([bandelierPeakTags, bandelierReserve]), pack: "nm").klass,
            "Peak"
        )

        let sedilloPark: [String: String] = [
            "leisure": "park",
            "name": "Sedillo Ridge Open Space",
        ]
        let juanPath: [String: String] = [
            "highway": "path",
            "name": "Juan Trail",
        ]
        XCTAssertEqual(Inspect.pick([sedilloPark, juanPath])["leisure"], "park")
        XCTAssertEqual(
            Inspect.read(tags: Inspect.pick([sedilloPark, juanPath]), pack: "nm").klass,
            "Open reserve"
        )

        let ojitoSanPark: [String: String] = [
            "leisure": "park",
            "name": "Ojito de San Antonio Open Space",
        ]
        let ojoRoad: [String: String] = [
            "highway": "residential",
            "name": "Ojo Grande Drive",
        ]
        ...
        let billyReserve: [String: String] = [
            "leisure": "nature_reserve",
            "name": "Billy Rogers Arroyo",
        ]
        let robinsonRoad: [String: String] = [
            "highway": "residential",
            "name": "East Robinson Avenue",
        ]
        XCTAssertEqual(Inspect.pick([billyReserve, robinsonRoad])["leisure"], "nature_reserve")
        XCTAssertEqual(
            Inspect.read(tags: Inspect.pick([billyReserve, robinsonRoad]), pack: "tx-west").klass,
            "Open reserve"
        )

        let piedmontReserve: [String: String] = [
            "leisure": "nature_reserve",
            "name": "Piedmont City Preserve",
        ]
        let cerroRoad: [String: String] = [
            "highway": "service",
            "name": "Cerro de Paz",
        ]
        XCTAssertEqual(Inspect.pick([piedmontReserve, cerroRoad])["leisure"], "nature_reserve")
        XCTAssertEqual(
            Inspect.read(tags: Inspect.pick([piedmontReserve, cerroRoad]), pack: "tx-west").klass,
            "Open reserve"
        )

        let northOpenReserve: [String: String] = [
            "leisure": "nature_reserve",
            "name": "North Open Reserve",
        ]
        let ridgeTopDrive: [String: String] = [
            "highway": "residential",
            "name": "Ridge Top Drive",
        ]
        XCTAssertEqual(Inspect.pick([northOpenReserve, ridgeTopDrive])["leisure"], "nature_reserve")
        XCTAssertEqual(
            Inspect.read(tags: Inspect.pick([northOpenReserve, ridgeTopDrive]), pack: "tx-west").klass,
            "Open reserve"
        )

        let southOpenReserve: [String: String] = [
            "leisure": "nature_reserve",
            "name": "South Open Reserve",
        ]
        let alabamaWay: [String: String] = [
            "highway": "secondary",
            "name": "Alabama Street",
        ]
        XCTAssertEqual(Inspect.pick([southOpenReserve, alabamaWay])["leisure"], "nature_reserve")
        XCTAssertEqual(
            Inspect.read(tags: Inspect.pick([southOpenReserve, alabamaWay]), pack: "tx-west").klass,
            "Open reserve"
        )

        let westsideReserve: [String: String] = [
            "leisure": "nature_reserve",
            "name": "Westside Preserve",
        ]
        let bitLane: [String: String] = [
            "highway": "residential",
            "name": "Bit Lane",
        ]
        XCTAssertEqual(Inspect.pick([westsideReserve, bitLane])["leisure"], "nature_reserve")
        XCTAssertEqual(
            Inspect.read(tags: Inspect.pick([westsideReserve, bitLane]), pack: "tx-east").klass,
            "Open reserve"
        )

        let southHillsReserve: [String: String] = [
            "leisure": "nature_reserve",
            "name": "South Hills Conservation Area",
        ]
        let indianGrassFill: [String: String] = [
            "leisure": "nature_reserve",
            "name": "Indian Grass Prarie Preserve",
        ]
        XCTAssertEqual(
            Inspect.read(tags: southHillsReserve, pack: "tx-east").klass,
            "Open reserve"
        )
        XCTAssertNotEqual(
            Inspect.read(tags: southHillsReserve, pack: "tx-east").klass,
        ...
        XCTAssertEqual(
            Inspect.read(tags: indianGrassFill, pack: "tx-east").klass,
            "Open reserve"
        )
        ...
        let oakdaleReserve: [String: String] = [
            "leisure": "nature_reserve",
            "name": "Brodie and Oakdale Properties",
        ]
        let oakdaleDrive: [String: String] = [
            "highway": "residential",
            "name": "Oakdale Drive",
        ]
        XCTAssertEqual(Inspect.pick([oakdaleReserve, oakdaleDrive])["leisure"], "nature_reserve")
        XCTAssertEqual(
            Inspect.read(tags: Inspect.pick([oakdaleReserve, oakdaleDrive]), pack: "tx-east").klass,
            "Open reserve"
        )

        let wasteReserve: [String: String] = [
            "leisure": "nature_reserve",
            "name": "Waste Management Wildlife Park",
        ]
        let springdaleRoad: [String: String] = [
            "highway": "tertiary",
            "name": "Springdale Road",
        ]
        XCTAssertEqual(Inspect.pick([wasteReserve, springdaleRoad])["leisure"], "nature_reserve")
        XCTAssertEqual(
            Inspect.read(tags: Inspect.pick([wasteReserve, springdaleRoad]), pack: "tx-east").klass,
            "Open reserve"
        )
        XCTAssertNotEqual(
            Inspect.read(tags: Inspect.pick([wasteReserve, springdaleRoad]), pack: "tx-east").klass,
        ...
        let walnutReserve: [String: String] = [
            "leisure": "nature_reserve",
            "name": "Southern Walnut Creek Greenbelt",
        ]
        let walnutTrail: [String: String] = [
            "highway": "cycleway",
            "name": "Southern Walnut Creek Trail",
        ]
        XCTAssertEqual(Inspect.pick([walnutReserve, walnutTrail])["leisure"], "nature_reserve")
        XCTAssertEqual(
            Inspect.read(tags: Inspect.pick([walnutReserve, walnutTrail]), pack: "tx-east").klass,
            "Open reserve"
        )

        let uplandsReserve: [String: String] = [
            "leisure": "nature_reserve",
            "name": "Uplands",
        ]
        let southLamar: [String: String] = [
            "highway": "secondary",
            "name": "South Lamar Boulevard",
        ]
        XCTAssertEqual(Inspect.pick([uplandsReserve, southLamar])["leisure"], "nature_reserve")
        XCTAssertEqual(
            Inspect.read(tags: Inspect.pick([uplandsReserve, southLamar]), pack: "tx-east").klass,
            "Open reserve"
        )

        let westgateReserve: [String: String] = [
            "leisure": "nature_reserve",
            "name": "Westgate and Sunset Properties",
        ]
        let westWindTrail: [String: String] = [
            "highway": "residential",
            "name": "West Wind Trail",
        ]
        XCTAssertEqual(Inspect.pick([westgateReserve, westWindTrail])["leisure"], "nature_reserve")
        XCTAssertEqual(
            Inspect.read(tags: Inspect.pick([westgateReserve, westWindTrail]), pack: "tx-east").klass,
            "Open reserve"
        )
        ...
        let barleyRoad: [String: String] = [
            "highway": "track",
            "name": "Barley Canyon Road",
        ]
        XCTAssertEqual(Inspect.pick([fentonReserve, barleyRoad])["leisure"], "nature_reserve")
        XCTAssertEqual(
            Inspect.read(tags: Inspect.pick([fentonReserve, barleyRoad]), pack: "nm").klass,
            "Open reserve"
        )
        XCTAssertNotEqual(
            Inspect.read(tags: barleyRoad, pack: "nm").klass,
            "Open reserve"
        )

        let pinoReserve: [String: String] = [
            "leisure": "park",
            "name": "Pino Arroyo Open Space",
        ]
        let quailCourt: [String: String] = [
            "highway": "residential",
            "name": "Quail Run Court Northeast",
        ]
        XCTAssertEqual(Inspect.pick([pinoReserve, quailCourt])["leisure"], "park")
        XCTAssertEqual(
            Inspect.read(tags: Inspect.pick([pinoReserve, quailCourt]), pack: "nm").klass,
            "Open reserve"
        )

        let santaFeReserve: [String: String] = [
            "leisure": "park",
            "name": "Santa Fe Open Space",
        ]
        let paseoVista: [String: String] = [
            "highway": "residential",
            "name": "Paseo de Vista",
        ]
        XCTAssertEqual(Inspect.pick([santaFeReserve, paseoVista])["leisure"], "park")
        XCTAssertEqual(
            Inspect.read(tags: Inspect.pick([santaFeReserve, paseoVista]), pack: "nm").klass,
            "Open reserve"
        )
        ...
        let santaFeForestTags: [String: String] = [
            "boundary": "protected_area",
            "name": "Santa Fe National Forest",
        ]
        XCTAssertEqual(Inspect.pick([pecosWildReserve, santaFeForestTags])["name"], "Pecos Wilderness")
        XCTAssertEqual(
            Inspect.read(tags: Inspect.pick([pecosWildReserve, santaFeForestTags]), pack: "nm").klass,
            "Open reserve"
        )
        XCTAssertEqual(
    ...
    func testABotanicGardenIsWorkedGroundNotAMeal() {
        ...
        let pattersonGarden = Inspect.read(
            tags: ["leisure": "garden", "name": "Patterson Park Community Garden"],
            pack: "tx-east"
        )
        XCTAssertEqual(pattersonGarden.klass, "Botanic garden")
        XCTAssertNotEqual(pattersonGarden.klass, "Park")
        XCTAssertEqual(pattersonGarden.fieldRoute.first, Inspect.plantTXCard)
        XCTAssertFalse(pattersonGarden.fieldRoute.contains(Inspect.treeUseEastCard))
        XCTAssertFalse(pattersonGarden.doLine.lowercased().contains("edible"), pattersonGarden.doLine)

        let cherryCreekGarden = Inspect.read(
            tags: ["leisure": "garden", "name": "Cherry Creek Community Garden"],
            pack: "tx-east"
        )
        XCTAssertEqual(cherryCreekGarden.klass, "Botanic garden")
        XCTAssertNotEqual(cherryCreekGarden.klass, "Park")
        XCTAssertEqual(cherryCreekGarden.fieldRoute.first, Inspect.plantTXCard)
        XCTAssertFalse(cherryCreekGarden.fieldRoute.contains(Inspect.treeUseEastCard))
        XCTAssertFalse(cherryCreekGarden.fieldRoute.contains(Inspect.cactusTXCard))
        XCTAssertTrue(cherryCreekGarden.doLine.lowercased().contains("oleander"), cherryCreekGarden.doLine)
        XCTAssertFalse(cherryCreekGarden.doLine.lowercased().contains("edible"), cherryCreekGarden.doLine)

        let baytonLoop = Inspect.read(
            tags: ["highway": "residential", "name": "Bayton Loop"],
            pack: "tx-east"
        )
        XCTAssertEqual(baytonLoop.klass, "Road")
        XCTAssertNotEqual(baytonLoop.klass, "Botanic garden")

        let cherryCreekDrive = Inspect.read(
            tags: ["highway": "residential", "name": "Cherry Creek Drive"],
            pack: "tx-east"
        )
        XCTAssertEqual(cherryCreekDrive.klass, "Road")
        XCTAssertNotEqual(cherryCreekDrive.klass, "Botanic garden")

        let brookviewRoad = Inspect.read(
            tags: ["highway": "residential", "name": "Brookview Road"],
            pack: "tx-east"
        )
        XCTAssertEqual(brookviewRoad.klass, "Road")
        XCTAssertNotEqual(brookviewRoad.klass, "Botanic garden")
        ...
        let adamGabriel = Inspect.read(
            tags: [
                "leisure": "garden",
                "landuse": "allotments",
                "name": "Adam Gabriel Armijo Community Garden",
            ],
            state: "NM",
            pack: "nm"
        )
        XCTAssertEqual(adamGabriel.klass, "Botanic garden")
        XCTAssertNotEqual(adamGabriel.klass, "Park")
        XCTAssertEqual(adamGabriel.fieldRoute.first, Inspect.plantTXCard)
        XCTAssertTrue(adamGabriel.fieldRoute.contains(Inspect.plantNMCard))
        XCTAssertFalse(adamGabriel.fieldRoute.contains(Inspect.treeUseNMCard))
        XCTAssertFalse(adamGabriel.doLine.lowercased().contains("edible"), adamGabriel.doLine)

        let cerroGordoPark = Inspect.read(
            tags: ["leisure": "park", "name": "Cerro Gordo Park"],
            pack: "nm"
        )
        XCTAssertEqual(cerroGordoPark.klass, "Park")
        XCTAssertNotEqual(cerroGordoPark.klass, "Botanic garden")

        let cerroGordoRoad = Inspect.read(
            tags: ["highway": "service", "name": "Cerro Gordo Road"],
            pack: "nm"
        )
        XCTAssertEqual(cerroGordoRoad.klass, "Service road")
        XCTAssertNotEqual(cerroGordoRoad.klass, "Botanic garden")
    ...
    func testABotanicGardenBeatsParkFillAndANamedStreet() {
        ...
        let adamSheet: [String: String] = [
            "leisure": "garden",
            "landuse": "allotments",
            "name": "Adam Gabriel Armijo Community Garden",
        ]
        let cerroGordoStreet: [String: String] = [
            "highway": "service",
            "name": "Cerro Gordo Road",
        ]
        let cerroGordoParkFill: [String: String] = [
            "leisure": "park",
            "name": "Cerro Gordo Park",
        ]
        XCTAssertEqual(Inspect.pick([adamSheet, cerroGordoStreet, cerroGordoParkFill])["leisure"], "garden")
        XCTAssertEqual(
            Inspect.read(tags: Inspect.pick([adamSheet, cerroGordoStreet, cerroGordoParkFill]), pack: "nm").klass,
            "Botanic garden"
        )

        let pattersonSheet: [String: String] = [
            "leisure": "garden",
            "name": "Patterson Park Community Garden",
        ]
        let brookviewStreet: [String: String] = [
            "highway": "residential",
            "name": "Brookview Road",
        ]
        XCTAssertEqual(Inspect.pick([pattersonSheet, brookviewStreet])["leisure"], "garden")
        XCTAssertEqual(
            Inspect.pick([pattersonSheet, brookviewStreet])["name"],
        ...
        let cherryCreekSheet: [String: String] = [
            "leisure": "garden",
            "name": "Cherry Creek Community Garden",
        ]
        let baytonStreet: [String: String] = [
            "highway": "residential",
            "name": "Bayton Loop",
        ]
        let cherryDrive: [String: String] = [
            "highway": "residential",
            "name": "Cherry Creek Drive",
        ]
        XCTAssertEqual(Inspect.pick([cherryCreekSheet, baytonStreet, cherryDrive])["leisure"], "garden")
        XCTAssertEqual(
            Inspect.pick([cherryCreekSheet, baytonStreet, cherryDrive])["name"],
            "Cherry Creek Community Garden"
        )
        XCTAssertEqual(
            Inspect.read(tags: Inspect.pick([cherryCreekSheet, baytonStreet, cherryDrive]), pack: "tx-east").klass,
            "Botanic garden"
        )
