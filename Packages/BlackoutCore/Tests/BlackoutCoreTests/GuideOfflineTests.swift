...
final class GuideOfflineTests: XCTestCase {
    ...
    func testFieldAskHomeIsAskPlusChipsNotEncyclopedia() {
        ...
        XCTAssertFalse(FieldAskHomeLock.paintsHonestyOnHome)
        XCTAssertFalse(FieldAskHomeLock.browseIsMetalSlab)
        XCTAssertEqual(FieldAskHomeLock.homeStackSpacing, 8)
        XCTAssertEqual(FieldAskHomeLock.chipColumns, 3)
        ...
        XCTAssertFalse(FieldAskHomeLock.skillsIsFieldSegment)
        XCTAssertEqual(FieldAskHomeLock.fieldSegmentTitles, ["Guide", "Vision"])
        XCTAssertFalse(FieldAskHomeLock.stepShowsPictogramBar)
        XCTAssertFalse(FieldAskHomeLock.stepShowsSendOnFirstPlate)
        XCTAssertFalse(FieldAskHomeLock.stepShowsShowTextOnFirstPlate)
