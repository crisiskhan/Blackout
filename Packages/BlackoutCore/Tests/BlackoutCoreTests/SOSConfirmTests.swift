...
final class SOSConfirmTests: XCTestCase {
    ...
    func testColdLaunchLandsOnUnlockNotArmedOrBitmap() {
        ...
        XCTAssertFalse(LaunchLock.startsPackPathMonitorInInit)
        ...
        XCTAssertFalse(RootChromeLock.sosOverlayMounts(isUnlocked: false, coverRequested: true))
        XCTAssertFalse(RootChromeLock.sosOverlayMounts(isUnlocked: true, coverRequested: false))
