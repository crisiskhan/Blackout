...
public enum FieldCorpus {
    ...
    private static let boost: [String: [String]] = [
        ...
        "rain": ["water-catch", "env-flood", "fire-wet"],
        "dew": ["water-catch"],
        "urine": ["water-find"],
        "seawater": ["water-find", "env-coast"],
        ...
        "lost": ["nav-lost", "tact-staygo"],
        "perdido": ["nav-lost"],
        "gps": ["nav-lost"],
        "signal": ["sig-mirror", "sig-ground"],
        "mirror": ["sig-mirror"],
        "smoke": ["sig-ground", "fire-spark", "env-smoke", "env-wildfire"],
        ...
        "cold": ["env-cold"],
        "wet": ["env-cold", "shelter-tarp", "fire-wet", "camp-layers"],
        ...
        "bog": ["env-bog"],
        "mud": ["env-bog"],
        "swamp": ["env-bog", "shelter-platform"],
        "latrine": ["camp-latrine"],
        "toilet": ["camp-latrine", "water-urban"],
        ...
        "cholla": ["nm-cactus"],
        "sotol": ["nm-cactus"],
        "mesquite": ["tx-tree-use"],
        "pecan": ["tx-tree-use", "tx-east-tree-use"],
        "cottonwood": ["tx-tree-use", "tx-east-tree-use", "nm-tree-use"],
        "loblolly": ["tx-east-tree-use"],
        "ponderosa": ["nm-tree-use"],
        "juniper": ["nm-tree-use"],
        "pinon": ["nm-tree-use"],
        "aspen": ["nm-tree-use"],
        ...
        "softshell": ["animal-turtle"],
        "frog": ["animal-frog"],
        "toad": ["animal-frog"],
        "bullfrog": ["animal-frog"],
        "rana": ["animal-frog"],
        "sapo": ["animal-frog"],
        "amanita": ["fungi-leave"],
        "morel": ["fungi-leave"],
        "lantern": ["fungi-leave"],
        "jackrabbit": ["tx-mammal", "nm-mammal"],
        "raccoon": ["tx-mammal", "tx-east-mammal"],
        "squirrel": ["tx-mammal", "tx-east-mammal", "nm-mammal"],
        "fox": ["tx-mammal", "tx-east-mammal", "nm-mammal"],
        "skunk": ["tx-mammal", "tx-east-mammal"],
        "armadillo": ["tx-mammal", "tx-east-mammal"],
        "bobcat": ["tx-mammal", "tx-east-mammal"],
        "pronghorn": ["nm-mammal"],
        "liebre": ["tx-mammal", "nm-mammal"],
        "mapache": ["tx-mammal"],
        "ardilla": ["tx-mammal", "nm-mammal"],
        "zorro": ["tx-mammal", "nm-mammal"],
        ...
        "cotton": ["env-cold", "env-core-temp", "camp-layers"],
        ...
        "watch": ["camp-watch", "env-night-move"],
        "night": ["camp-watch", "env-night-move", "camp-light", "camp-sleep"],
        "seep": ["water-seep"],
        "wildfire": ["env-wildfire"],
        "fireline": ["env-wildfire"],
        "stretcher": ["trauma-carry"],
        "litter": ["trauma-carry"],
        "carry": ["trauma-carry"],
        "frostbite": ["env-frostbite"],
        "frost": ["env-frostbite", "env-cold"],
        "altitude": ["env-altitude"],
        "elevation": ["env-altitude"],
        "tide": ["env-coast"],
        "surf": ["env-coast"],
        "ocean": ["env-coast", "water-find"],
        "coast": ["env-coast"],
        "sweat": ["camp-sweat", "env-desert-day"],
        "char": ["fire-char"],
        "talus": ["env-scree"],
        "scree": ["env-scree"],
        "gator": ["animal-gator"],
        ...
        "rockboil": ["water-rockboil"],
        "wind": ["env-wind"],
        "lee": ["env-wind"],
        "reflector": ["fire-reflector"],
        "wool": ["camp-layers"],
        "layer": ["camp-layers"],
        "hat": ["camp-layers"],
        "clothing": ["camp-layers"],
        "tape": ["camp-tape"],
        "bag": ["camp-tape", "water-vessel"],
        "knot": ["shelter-knots"],
        "hitch": ["shelter-knots"],
        "taut": ["shelter-knots"],
        "pace": ["nav-pace"],
        ...
        "cramp": ["water-salt"],
        "stay": ["tact-staygo"],
        "evacuate": ["tact-staygo", "env-wildfire"],
        "pack": ["camp-pack"],
        "load": ["camp-pack"],
        "rest": ["camp-rest-step"],
    ]
