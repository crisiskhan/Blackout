...
/// Idle clock for Map chrome. Recedes GPS + chips + scale bar after 2s
/// without pan / zoom / tap. Hold (sheets, dest, deny, live Rec, SOS)
/// and Reduce Motion keep chrome static. SOS FAB is not part of this flag.
